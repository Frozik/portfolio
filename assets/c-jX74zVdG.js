import{F as e,N as t,P as n,ct as r}from"./c-DPkLgPic.js";import{i,r as a,t as o}from"./c-Czl7OTz9.js";import{i as s,n as c,r as l,t as u}from"./c-BBEFB0xa.js";import{t as d}from"./c-wJEgkeeX.js";var f=r(n(),1),p=.149,m=.149,h=.149,g=.5,_=.7,v=1e-4,y=16384,b=.5,x=.4,S=.6,C=`rgba8unorm`,w=1e3;function T(e){return Math.trunc(e/20/4)*4+1}function E(e){return Math.trunc(e/20/4)*4+1}var D={color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}};function O(t,n,r){let i=null,a=null,o=null,s=null,c=null;return{ensureOffscreenTextures(l,u,d,f,p){return!e(i)&&i.width===l&&i.height===u?e(a)||e(s)||e(c)?null:{offscreenMsaaView:a,offscreenResolveView:s,compositeBindGroup:c}:(i?.destroy(),o?.destroy(),l===0||u===0?(i=null,a=null,o=null,s=null,c=null,null):(i=t.createTexture({size:[l,u],format:n,sampleCount:r,usage:GPUTextureUsage.RENDER_ATTACHMENT}),a=i.createView(),o=t.createTexture({size:[l,u],format:n,sampleCount:1,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),s=o.createView(),c=t.createBindGroup({layout:d,entries:[{binding:0,resource:s},{binding:1,resource:f},{binding:2,resource:{buffer:p}}]}),{offscreenMsaaView:a,offscreenResolveView:s,compositeBindGroup:c}))},destroy(){i?.destroy(),o?.destroy()}}}var k=`struct CompositeUniforms {
    opacity: f32,
};
