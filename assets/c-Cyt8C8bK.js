import{i as e}from"./c-Dd_uD5pT.js";import{B as t,it as n}from"./c-C8QCGV-W.js";import{i as r}from"./c-DP_47kS8.js";import{r as i,t as a}from"./c-Dc1K2tBE.js";import{t as o}from"./c-BUVw3GsZ.js";import{t as s}from"./c-BRvpTXxQ.js";import{n as c,r as l,t as u}from"./c-B8Q5TKVj.js";import{i as d,t as f}from"./c-Dr8IWdrq.js";import{t as p}from"./c-C0PiR4rC.js";import{n as m,t as h}from"./c-ChaKfK4V.js";var g=e(r(),1),_=.7,v=1e-4,y=16384,b=.5,x=.4,S=.01,C=.6;function w(e){return Math.trunc(e/20/4)*4+1}function T(e){return Math.trunc(e/20/4)*4+1}var E=`rgba8unorm`,D={color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}};function ee(e,t){let r,i,a;function o(){r?.destroy(),i?.destroy(),r=void 0,i=void 0,a=void 0}return{ensure(s,c){if(!n(r)&&r.width===s&&r.height===c)return a;if(o(),s===0||c===0)return;r=e.createTexture({size:[s,c],format:t.format,sampleCount:t.sampleCount,usage:GPUTextureUsage.RENDER_ATTACHMENT}),i=e.createTexture({size:[s,c],format:t.format,sampleCount:1,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING});let l=i.createView();return a={msaaView:r.createView(),resolveView:l,compositeBindGroup:e.createBindGroup({layout:t.compositeBindGroupLayout,entries:[{binding:0,resource:l},{binding:1,resource:t.compositeSampler},{binding:2,resource:{buffer:t.compositeUniformBuffer}}]})},a},dispose:o}}var te=`struct CompositeUniforms {
    opacity: f32,
};
