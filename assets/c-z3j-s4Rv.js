...
`,ht={color:`#FFFFFF`,width:1,size:1,alpha:1,line:{type:`solid`},markerType:`solid`,strokeColor:`#FFFFFF`,strokeWidth:0},gt=16,_t=7,vt=255;function B(e){if(e.length!==_t||e[0]!==`#`)throw Error(`Invalid hex color: ${e}. Expected format: #RRGGBB`);return[Number.parseInt(e.slice(1,3),gt)/vt,Number.parseInt(e.slice(3,5),gt)/vt,Number.parseInt(e.slice(5,7),gt)/vt]}function yt(e){let t=[...e].sort(),n=[[]];for(let e of t){let t=n.length;for(let r=0;r<t;r++)n.push([...n[r],e])}return n.sort((e,t)=>e.length===t.length?e.join(`:`).localeCompare(t.join(`:`)):e.length-t.length),n}function bt(e,t){return{color:t.color??e.color,width:t.width??e.width,size:t.size??e.size,alpha:t.alpha??e.alpha,line:t.line??e.line,markerType:t.markerType??e.markerType,strokeColor:t.strokeColor??e.strokeColor,strokeWidth:t.strokeWidth??e.strokeWidth}}function xt(e){let t={};for(let[n,r]of Object.entries(e)){let e=n.split(`:`);if(e.length<=2){t[n]=r;continue}let i=e[0],a=e.slice(1).sort();t[`${i}:${a.join(`:`)}`]=r}return t}function V(e,t,n){let r=xt(e),i=yt(n),a={...ht};for(let e of i){let n=r[e.length===0?t:`${t}:${e.join(`:`)}`];n!==void 0&&(a=bt(a,n))}return a}var St=z+ut,Ct=z+dt,wt=z+ft,Tt=z+pt,Et=z+mt,H=`depth24plus`,Dt=`rg32float`,U=1,Ot=2,kt=1,At=0,jt=1,Mt=2,Nt=4,Pt=32,W=Pt*Nt,Ft=[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x3`},{shaderLocation:2,offset:24,format:`float32`},{shaderLocation:3,offset:28,format:`float32x3`},{shaderLocation:4,offset:40,format:`float32`},{shaderLocation:5,offset:44,format:`float32`},{shaderLocation:6,offset:48,format:`float32`},{shaderLocation:7,offset:52,format:`float32`},{shaderLocation:8,offset:56,format:`float32`},{shaderLocation:9,offset:60,format:`float32x3`},{shaderLocation:10,offset:72,format:`float32`},{shaderLocation:11,offset:76,format:`float32`},{shaderLocation:12,offset:80,format:`float32`},{shaderLocation:13,offset:84,format:`float32`}],It=[...Ft,{shaderLocation:14,offset:88,format:`float32`},{shaderLocation:15,offset:92,format:`float32`}],Lt=24,G=Lt*Nt,Rt=3*Nt,zt=7*Nt,Bt=128,Vt=0,Ht=64,Ut=72,Wt=80,Gt=108,Kt=96,qt=6,Jt=class{device;format;hiddenLinePipeline;visibleLinePipeline;previewLinePipeline;hiddenMarkerPipeline;visibleMarkerPipeline;previewMarkerPipeline;hiddenLineIdPipeline;visibleLineIdPipeline;bindGroup;lineBindGroup;previewLineBindGroup;markerBindGroup;previewMarkerBindGroup;depthBindGroupLayout;markerBindGroupLayout;uniformBuffer;previewUniformBuffer;faceVertexBuffer;styledLineBuffer;topologyVertexMarkerBuffer;previewLineBuffer;previewStartMarkerBuffer;previewSnapMarkerBuffer;depthPrePassPipeline;solutionFacePipeline;solutionFaceBuffer;solutionFaceVertexCount=0;depthSampler;faceVertexCount=0;depthTexture=null;samplingDepthTexture=null;lineEndpointTexture=null;lineDepthTexture=null;lastMvpMatrix=new Float32Array(16);styledLineCount=0;topologyVertexCount=0;hasDragPreview=!1;hasStartMarker=!1;currentPreviewLine;hasSnapTarget=!1;lastCanvasWidth=0;lastCanvasHeight=0;lastDevicePixelRatio=1;backgroundClearColor;vertexPreviewStyle;constructor(e,t,n,r,i,a=`perspective`){this.camera=e,this.msaaManager=t,this.topology=n,this.fpsController=r,this.sceneCenter=i,this.projection=a;let[o,s,c]=B(V(F,`background`,[]).color);this.backgroundClearColor={r:o,g:s,b:c,a:1};let l=V(F,`vertex`,[`preview`]);this.vertexPreviewStyle={markerType:l.markerType===`circle`?1:0,size:l.size,color:B(l.color),alpha:l.alpha,strokeColor:B(l.strokeColor),strokeWidth:l.strokeWidth}}init(e){this.device=e.device,this.format=e.format;let t=Oe(this.topology);this.faceVertexCount=t.faceVertexCount,this.faceVertexBuffer=this.createAndWriteBuffer(t.facePositions,GPUBufferUsage.VERTEX),this.solutionFaceBuffer=this.device.createBuffer({size:zt,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});let n=this.topology.edges.length*(this.topology.edges.length-1)/2,r=Math.max(1,this.topology.edges.length+n);this.styledLineBuffer=this.device.createBuffer({size:Math.max(W,r*W),usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});let i=this.topology.vertices.length+n;this.topologyVertexMarkerBuffer=this.device.createBuffer({size:i*G,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this.previewLineBuffer=this.device.createBuffer({size:W,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this.previewStartMarkerBuffer=this.device.createBuffer({size:G,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this.previewSnapMarkerBuffer=this.device.createBuffer({size:G,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this.uniformBuffer=this.device.createBuffer({size:Bt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.previewUniformBuffer=this.device.createBuffer({size:Bt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});let a=new Float32Array([xe,Se]);this.device.queue.writeBuffer(this.uniformBuffer,Gt,a),this.device.queue.writeBuffer(this.previewUniformBuffer,Gt,a);let o=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]});this.bindGroup=this.device.createBindGroup({layout:o,entries:[{binding:0,resource:{buffer:this.uniformBuffer}}]});let s=this.device.createPipelineLayout({bindGroupLayouts:[o]});this.depthPrePassPipeline=this.createDepthPrePassPipeline(s),this.solutionFacePipeline=this.createSolutionFacePipeline(s),this.depthBindGroupLayout=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,texture:{sampleType:`depth`}},{binding:2,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,sampler:{type:`non-filtering`}}]}),this.markerBindGroupLayout=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,texture:{sampleType:`depth`}},{binding:2,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,sampler:{type:`non-filtering`}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`unfilterable-float`}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`depth`}}]}),this.depthSampler=this.device.createSampler({minFilter:`nearest`,magFilter:`nearest`});let c=this.device.createPipelineLayout({bindGroupLayouts:[this.depthBindGroupLayout]});this.hiddenLinePipeline=this.createLinePipeline(c,jt),this.visibleLinePipeline=this.createLinePipeline(c,Mt),this.previewLinePipeline=this.createPreviewLinePipeline(c);let l=this.device.createPipelineLayout({bindGroupLayouts:[this.markerBindGroupLayout]});this.hiddenMarkerPipeline=this.createMarkerPipeline(l,jt),this.visibleMarkerPipeline=this.createMarkerPipeline(l,Mt),this.previewMarkerPipeline=this.createMarkerPipeline(l,At,!1),this.hiddenLineIdPipeline=this.createLineIdPipeline(c,jt),this.visibleLineIdPipeline=this.createLineIdPipeline(c,Mt)}update(e){this.camera.tick()&&this.fpsController.raise(60);let t=this.camera.getViewMatrix(),n=this.camera.getDistance(),r=e.canvasWidth/Math.max(U,e.canvasHeight),i=this.projection===`orthographic`?(()=>{let e=n*ge,t=e*r;return M.ortho(-t,t,-e,e,he,100)})():M.perspective(me,r,he,100),a=M.multiply(i,t);this.lastMvpMatrix.set(a),this.lastCanvasWidth=e.canvasWidth,this.lastCanvasHeight=e.canvasHeight,this.lastDevicePixelRatio=e.devicePixelRatio;let o=new Float32Array([-t[2],-t[6],-t[10]]);this.device.queue.writeBuffer(this.uniformBuffer,Vt,a);let s=new Float32Array([e.canvasWidth,e.canvasHeight]);this.device.queue.writeBuffer(this.uniformBuffer,Ht,s);let c=new Float32Array([e.devicePixelRatio,n]);this.device.queue.writeBuffer(this.uniformBuffer,Ut,c),this.device.queue.writeBuffer(this.uniformBuffer,Wt,o);let l=new Float32Array(this.sceneCenter);this.device.queue.writeBuffer(this.uniformBuffer,Kt,l),this.device.queue.writeBuffer(this.previewUniformBuffer,Vt,a),this.device.queue.writeBuffer(this.previewUniformBuffer,Ht,s),this.device.queue.writeBuffer(this.previewUniformBuffer,Ut,c),this.device.queue.writeBuffer(this.previewUniformBuffer,Wt,o),this.device.queue.writeBuffer(this.previewUniformBuffer,Kt,l)}render(e,t,n){let r=this.msaaManager.ensureView(this.device,this.format,n.canvasWidth,n.canvasHeight);if(p(r))return;let i=this.ensureDepthTexture(n.canvasWidth,n.canvasHeight),a=this.ensureSamplingDepthTexture(n.canvasWidth,n.canvasHeight),o=e.beginRenderPass({colorAttachments:[],depthStencilAttachment:{view:a,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});o.setPipeline(this.depthPrePassPipeline),o.setBindGroup(0,this.bindGroup),o.setVertexBuffer(0,this.faceVertexBuffer),o.draw(this.faceVertexCount),o.end();let s=this.ensureLineIdTextures(n.canvasWidth,n.canvasHeight,a),c=i.createView(),l={r:-1,g:-1,b:0,a:0};if(this.styledLineCount>0){let t=e.beginRenderPass({colorAttachments:[{view:s.endpointView,clearValue:l,loadOp:`clear`,storeOp:`store`}],depthStencilAttachment:{view:s.depthView,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});t.setPipeline(this.hiddenLineIdPipeline),t.setBindGroup(0,this.lineBindGroup),t.setVertexBuffer(0,this.styledLineBuffer),t.draw(6,this.styledLineCount),t.end()}let u=e.beginRenderPass({colorAttachments:[{view:r,loadOp:`clear`,clearValue:this.backgroundClearColor,storeOp:`store`}],depthStencilAttachment:{view:c,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`discard`}});if(this.solutionFaceVertexCount>0&&(u.setPipeline(this.solutionFacePipeline),u.setBindGroup(0,this.bindGroup),u.setVertexBuffer(0,this.solutionFaceBuffer),u.draw(this.solutionFaceVertexCount)),this.styledLineCount>0&&(u.setPipeline(this.hiddenLinePipeline),u.setBindGroup(0,this.lineBindGroup),u.setVertexBuffer(0,this.styledLineBuffer),u.draw(6,this.styledLineCount)),this.topologyVertexCount>0&&(u.setPipeline(this.hiddenMarkerPipeline),u.setBindGroup(0,this.markerBindGroup),u.setVertexBuffer(0,this.topologyVertexMarkerBuffer),u.draw(qt,this.topologyVertexCount)),u.end(),this.styledLineCount>0){let t=e.beginRenderPass({colorAttachments:[{view:s.endpointView,clearValue:l,loadOp:`clear`,storeOp:`store`}],depthStencilAttachment:{view:s.depthView,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});t.setPipeline(this.visibleLineIdPipeline),t.setBindGroup(0,this.lineBindGroup),t.setVertexBuffer(0,this.styledLineBuffer),t.draw(6,this.styledLineCount),t.end()}let d=e.beginRenderPass({colorAttachments:[{view:r,resolveTarget:t,loadOp:`load`,storeOp:`discard`}],depthStencilAttachment:{view:c,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`discard`}});this.styledLineCount>0&&(d.setPipeline(this.visibleLinePipeline),d.setBindGroup(0,this.lineBindGroup),d.setVertexBuffer(0,this.styledLineBuffer),d.draw(6,this.styledLineCount)),this.topologyVertexCount>0&&(d.setPipeline(this.visibleMarkerPipeline),d.setBindGroup(0,this.markerBindGroup),d.setVertexBuffer(0,this.topologyVertexMarkerBuffer),d.draw(qt,this.topologyVertexCount)),this.hasDragPreview&&(d.setPipeline(this.previewLinePipeline),d.setBindGroup(0,this.previewLineBindGroup),d.setVertexBuffer(0,this.previewLineBuffer),d.draw(6,1)),this.hasStartMarker&&(d.setPipeline(this.previewMarkerPipeline),d.setBindGroup(0,this.previewMarkerBindGroup),d.setVertexBuffer(0,this.previewStartMarkerBuffer),d.draw(qt,1)),this.hasSnapTarget&&(d.setPipeline(this.previewMarkerPipeline),d.setBindGroup(0,this.previewMarkerBindGroup),d.setVertexBuffer(0,this.previewSnapMarkerBuffer),d.draw(qt,1)),d.end()}getLastMvpMatrix(){return this.lastMvpMatrix}getPreviewLine(){return this.currentPreviewLine}setDragPreview(e){if(p(e)){this.hasDragPreview=!1,this.hasStartMarker=!1,this.hasSnapTarget=!1,this.currentPreviewLine=void 0;return}let{pointA:t,pointB:n}=e.kind===`vertex`?this.computeVertexDragPreviewEndpoints(e):this.computeLineDragPreviewEndpoints(e);this.currentPreviewLine={pointA:t,pointB:n},this.writePreviewLineBuffer(t,n),this.hasDragPreview=!0,e.kind===`vertex`?(this.device.queue.writeBuffer(this.previewStartMarkerBuffer,0,this.createPreviewMarkerData(e.startPosition)),this.hasStartMarker=!0):this.hasStartMarker=!1,p(e.snapTargetPosition)?this.hasSnapTarget=!1:(this.device.queue.writeBuffer(this.previewSnapMarkerBuffer,0,this.createPreviewMarkerData(e.snapTargetPosition)),this.hasSnapTarget=!0)}computeVertexDragPreviewEndpoints(e){let t=p(e.snapTargetPosition)?this.unprojectToVertexPlane(e.cursorScreenX,e.cursorScreenY,e.startPosition):e.snapTargetPosition;return{pointA:e.startPosition,pointB:t}}computeLineDragPreviewEndpoints(e){let t=p(e.snapTargetPosition)?this.unprojectToVertexPlane(e.cursorScreenX,e.cursorScreenY,e.planeAnchor):e.snapTargetPosition;return{pointA:t,pointB:[t[0]+e.sourceDirection[0],t[1]+e.sourceDirection[1],t[2]+e.sourceDirection[2]]}}writePreviewLineBuffer(e,t){let n=V(F,`line`,[`preview`]),[r,i,a]=B(n.color),o=new Float32Array(Pt);o[0]=e[0],o[1]=e[1],o[2]=e[2],o[3]=t[0],o[4]=t[1],o[5]=t[2],o[6]=n.width,o[7]=r,o[8]=i,o[9]=a,o[10]=n.alpha,this.device.queue.writeBuffer(this.previewLineBuffer,0,o)}applySceneState(e){this.applyStyledMarkers(e.markers),this.applyStyledSegments(e.segments),this.applySolutionFace(e.solutionFace)}applySolutionFace(e){if(e===void 0||e.vertexCount===0){this.solutionFaceVertexCount=0;return}let t=e.vertices.byteLength;t>this.solutionFaceBuffer.size&&(this.solutionFaceBuffer.destroy(),this.solutionFaceBuffer=this.device.createBuffer({size:t,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST})),this.device.queue.writeBuffer(this.solutionFaceBuffer,0,e.vertices),this.solutionFaceVertexCount=e.vertexCount}applyStyledMarkers(e){if(this.topologyVertexCount=e.length,this.topologyVertexCount===0)return;let t=this.topologyVertexCount*G;t>this.topologyVertexMarkerBuffer.size&&(this.topologyVertexMarkerBuffer.destroy(),this.topologyVertexMarkerBuffer=this.device.createBuffer({size:t,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}));let n=new Float32Array(e.length*Lt);for(let t=0;t<e.length;t++){let r=e[t],i=t*Lt;n[i]=r.position[0],n[i+1]=r.position[1],n[i+2]=r.position[2],n[i+3]=r.markerType,n[i+4]=r.visibleStyle.size,n[i+5]=r.visibleStyle.color[0],n[i+6]=r.visibleStyle.color[1],n[i+7]=r.visibleStyle.color[2],n[i+8]=r.visibleStyle.alpha,n[i+9]=r.visibleStyle.strokeColor[0],n[i+10]=r.visibleStyle.strokeColor[1],n[i+11]=r.visibleStyle.strokeColor[2],n[i+12]=r.visibleStyle.strokeWidth,n[i+13]=r.hiddenStyle.size,n[i+14]=r.hiddenStyle.color[0],n[i+15]=r.hiddenStyle.color[1],n[i+16]=r.hiddenStyle.color[2],n[i+17]=r.hiddenStyle.alpha,n[i+18]=r.hiddenStyle.strokeColor[0],n[i+19]=r.hiddenStyle.strokeColor[1],n[i+20]=r.hiddenStyle.strokeColor[2],n[i+21]=r.hiddenStyle.strokeWidth,n[i+22]=r.vertexIndex}this.device.queue.writeBuffer(this.topologyVertexMarkerBuffer,0,n)}applyStyledSegments(e){if(this.styledLineCount=e.length,this.styledLineCount===0)return;let t=this.styledLineCount*W;t>this.styledLineBuffer.size&&(this.styledLineBuffer.destroy(),this.styledLineBuffer=this.device.createBuffer({size:t,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}));let n=new Float32Array(this.styledLineCount*Pt);for(let t=0;t<this.styledLineCount;t++)Yt(n,t,e[t]);this.device.queue.writeBuffer(this.styledLineBuffer,0,n)}dispose(){this.uniformBuffer.destroy(),this.previewUniformBuffer.destroy(),this.faceVertexBuffer.destroy(),this.solutionFaceBuffer.destroy(),this.styledLineBuffer.destroy(),this.topologyVertexMarkerBuffer.destroy(),this.previewLineBuffer.destroy(),this.previewStartMarkerBuffer.destroy(),this.previewSnapMarkerBuffer.destroy(),this.depthTexture?.destroy(),this.samplingDepthTexture?.destroy(),this.lineEndpointTexture?.destroy(),this.lineDepthTexture?.destroy()}unprojectToVertexPlane(e,t,n){let r=this.lastCanvasWidth,i=this.lastCanvasHeight,a=this.lastDevicePixelRatio,o=e*a,s=t*a,c=o/r*2-1,l=1-s/i*2,u=j.transformMat4(j.fromValues(n[0],n[1],n[2],1),this.lastMvpMatrix),d=u[2]/u[3],f=M.inverse(this.lastMvpMatrix),p=j.transformMat4(j.fromValues(c,l,d,1),f);return[p[0]/p[3],p[1]/p[3],p[2]/p[3]]}createAndWriteBuffer(e,t){let n=this.device.createBuffer({size:e.byteLength,usage:t|GPUBufferUsage.COPY_DST});return this.device.queue.writeBuffer(n,0,e),n}createLinePipeline(e,t){let n=this.device.createShaderModule({code:Ct});return this.device.createRenderPipeline({layout:e,vertex:{module:n,entryPoint:`vs`,buffers:[{arrayStride:W,stepMode:`instance`,attributes:Ft}]},fragment:{module:n,entryPoint:`fs`,constants:{renderMode:t},targets:[{format:this.format,blend:{color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`},depthStencil:{depthWriteEnabled:!0,depthCompare:`less-equal`,format:H},multisample:{count:4}})}createPreviewLinePipeline(e){let t=this.device.createShaderModule({code:Ct});return this.device.createRenderPipeline({layout:e,vertex:{module:t,entryPoint:`vs`,buffers:[{arrayStride:W,stepMode:`instance`,attributes:Ft}]},fragment:{module:t,entryPoint:`fs`,constants:{renderMode:At},targets:[{format:this.format,blend:{color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`},depthStencil:{depthWriteEnabled:!1,depthCompare:`always`,format:H},multisample:{count:4}})}createDepthPrePassPipeline(e){let t=this.device.createShaderModule({code:St});return this.device.createRenderPipeline({layout:e,vertex:{module:t,entryPoint:`vs`,buffers:[{arrayStride:Rt,attributes:[{shaderLocation:0,offset:0,format:`float32x3`}]}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{depthWriteEnabled:!0,depthCompare:`less`,format:H,depthBias:Ot,depthBiasSlopeScale:kt}})}createSolutionFacePipeline(e){let t=this.device.createShaderModule({code:Tt});return this.device.createRenderPipeline({layout:e,vertex:{module:t,entryPoint:`vs`,buffers:[{arrayStride:zt,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32x4`}]}]},fragment:{module:t,entryPoint:`fs`,targets:[{format:this.format,blend:{color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{depthWriteEnabled:!1,depthCompare:`always`,format:H},multisample:{count:4}})}createMarkerPipeline(e,t,n=!0){let r=this.device.createShaderModule({code:Et});return this.device.createRenderPipeline({layout:e,vertex:{module:r,entryPoint:`vs`,buffers:[{arrayStride:G,stepMode:`instance`,attributes:[{shaderLocation:0,offset:0,format:`float32x3`},{shaderLocation:1,offset:12,format:`float32`},{shaderLocation:2,offset:16,format:`float32`},{shaderLocation:3,offset:20,format:`float32x3`},{shaderLocation:4,offset:32,format:`float32`},{shaderLocation:5,offset:36,format:`float32x3`},{shaderLocation:6,offset:48,format:`float32`},{shaderLocation:7,offset:52,format:`float32`},{shaderLocation:8,offset:56,format:`float32x3`},{shaderLocation:9,offset:68,format:`float32`},{shaderLocation:10,offset:72,format:`float32x3`},{shaderLocation:11,offset:84,format:`float32`},{shaderLocation:12,offset:88,format:`float32`}]}]},fragment:{module:r,entryPoint:`fs`,constants:{renderMode:t,enableLineOcclusion:n?1:0},targets:[{format:this.format,blend:{color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`},depthStencil:{depthWriteEnabled:!1,depthCompare:`always`,format:H},multisample:{count:4}})}createLineIdPipeline(e,t){let n=this.device.createShaderModule({code:wt});return this.device.createRenderPipeline({layout:e,vertex:{module:n,entryPoint:`vs`,buffers:[{arrayStride:W,stepMode:`instance`,attributes:It}]},fragment:{module:n,entryPoint:`fs`,constants:{renderMode:t},targets:[{format:Dt}]},primitive:{topology:`triangle-list`},depthStencil:{depthWriteEnabled:!0,depthCompare:`less`,format:H}})}createPreviewMarkerData(e){let t=new Float32Array(Lt),n=this.vertexPreviewStyle;return t[0]=e[0],t[1]=e[1],t[2]=e[2],t[3]=n.markerType,t[4]=n.size,t[5]=n.color[0],t[6]=n.color[1],t[7]=n.color[2],t[8]=n.alpha,t[9]=n.strokeColor[0],t[10]=n.strokeColor[1],t[11]=n.strokeColor[2],t[12]=n.strokeWidth,t[13]=n.size,t[14]=n.color[0],t[15]=n.color[1],t[16]=n.color[2],t[17]=n.alpha,t[18]=n.strokeColor[0],t[19]=n.strokeColor[1],t[20]=n.strokeColor[2],t[21]=n.strokeWidth,t}ensureDepthTexture(e,t){return!p(this.depthTexture)&&this.depthTexture.width===e&&this.depthTexture.height===t?this.depthTexture:(this.depthTexture?.destroy(),this.depthTexture=this.device.createTexture({size:[Math.max(U,e),Math.max(U,t)],format:H,sampleCount:4,usage:GPUTextureUsage.RENDER_ATTACHMENT}),this.depthTexture)}ensureSamplingDepthTexture(e,t){let n=Math.max(U,e),r=Math.max(U,t);if(!p(this.samplingDepthTexture)&&this.samplingDepthTexture.width===n&&this.samplingDepthTexture.height===r)return this.samplingDepthTexture.createView();this.samplingDepthTexture?.destroy(),this.samplingDepthTexture=this.device.createTexture({size:[n,r],format:H,sampleCount:1,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING});let i=this.samplingDepthTexture.createView(),a=e=>[{binding:0,resource:{buffer:e}},{binding:1,resource:i},{binding:2,resource:this.depthSampler}];return this.lineBindGroup=this.device.createBindGroup({layout:this.depthBindGroupLayout,entries:a(this.uniformBuffer)}),this.previewLineBindGroup=this.device.createBindGroup({layout:this.depthBindGroupLayout,entries:a(this.previewUniformBuffer)}),this.samplingDepthTexture.createView()}ensureLineIdTextures(e,t,n){let r=Math.max(U,e),i=Math.max(U,t);if(!p(this.lineEndpointTexture)&&!p(this.lineDepthTexture)&&this.lineEndpointTexture.width===r&&this.lineEndpointTexture.height===i)return{endpointView:this.lineEndpointTexture.createView(),depthView:this.lineDepthTexture.createView()};this.lineEndpointTexture?.destroy(),this.lineDepthTexture?.destroy(),this.lineEndpointTexture=this.device.createTexture({size:[r,i],format:Dt,sampleCount:1,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),this.lineDepthTexture=this.device.createTexture({size:[r,i],format:H,sampleCount:1,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING});let a=this.lineEndpointTexture.createView(),o=this.lineDepthTexture.createView(),s=e=>[{binding:0,resource:{buffer:e}},{binding:1,resource:n},{binding:2,resource:this.depthSampler},{binding:3,resource:a},{binding:4,resource:o}];return this.markerBindGroup=this.device.createBindGroup({layout:this.markerBindGroupLayout,entries:s(this.uniformBuffer)}),this.previewMarkerBindGroup=this.device.createBindGroup({layout:this.markerBindGroupLayout,entries:s(this.previewUniformBuffer)}),{endpointView:a,depthView:o}}};function Yt(e,t,n){let r=t*Pt;e[r]=n.startPosition[0],e[r+1]=n.startPosition[1],e[r+2]=n.startPosition[2],e[r+3]=n.endPosition[0],e[r+4]=n.endPosition[1],e[r+5]=n.endPosition[2],e[r+6]=n.visibleStyle.width,e[r+7]=n.visibleStyle.color[0],e[r+8]=n.visibleStyle.color[1],e[r+9]=n.visibleStyle.color[2],e[r+10]=n.visibleStyle.alpha,e[r+11]=n.visibleStyle.lineType,e[r+12]=n.visibleStyle.dash,e[r+13]=n.visibleStyle.gap,e[r+14]=n.hiddenStyle.width,e[r+15]=n.hiddenStyle.color[0],e[r+16]=n.hiddenStyle.color[1],e[r+17]=n.hiddenStyle.color[2],e[r+18]=n.hiddenStyle.alpha,e[r+19]=n.hiddenStyle.lineType,e[r+20]=n.hiddenStyle.dash,e[r+21]=n.hiddenStyle.gap,e[r+22]=n.startVertexIndex,e[r+23]=n.endVertexIndex}var Xt=2,Zt=1e3,Qt=250;function $t(e){let{canvas:t,context:n,layerManager:r,fpsController:i,onFpsUpdate:a}=e,{device:o,canvasContext:s}=n,c=0,l=0,u=Math.max(1,window.devicePixelRatio);function d(){u=Math.max(1,window.devicePixelRatio);let e=Math.floor(t.clientWidth*u),n=Math.floor(t.clientHeight*u),r=t.width!==e||t.height!==n;return r&&(t.width=e,t.height=n),c=e,l=n,r}d();let f=new ResizeObserver(()=>{d(),i.raise(60)});f.observe(t);let p=0,m=!1,h=0,g=performance.now(),_=[],y=0;function b(e){let t=Math.max(Zt,i.getFrameIntervalMs()*3);_.push(e);let n=e-t;for(;_.length>0&&_[0]<n;)_.shift();if(e-y>=Qt){y=e;let t=_.length>1?_[_.length-1]-_[0]:0,n=t>0?Math.round((_.length-1)/t*v):0;a?.(n)}}function x(e){if(m)return;i.tick();let t=i.getFrameIntervalMs();if(e-h<t-Xt){p=requestAnimationFrame(x);return}if(h=e,b(e),d(),c===0||l===0){p=requestAnimationFrame(x);return}let n={time:(performance.now()-g)/v,canvasWidth:c,canvasHeight:l,devicePixelRatio:u};r.updateAll(n);let a=s.getCurrentTexture().createView(),f=o.createCommandEncoder();r.renderAll(f,a,n),o.queue.submit([f.finish()]),p=requestAnimationFrame(x)}return p=requestAnimationFrame(x),()=>{m=!0,cancelAnimationFrame(p),f.disconnect()}}var en=1e-5,tn=1e-10,nn=1e-8;function K(e,t,n=tn){return A.distSq(e,t)<n}function rn(e,t,n){let r=A.sub(n,t),i=A.dot(r,r);if(i<1e-10)return;let a=A.sub(e,t),o=A.dot(a,r)/i,s=A.addScaled(t,r,o);return{parameter:o,distanceSquared:A.distSq(e,s)}}function an(e,t,n){let r=rn(e,t,n);return r===void 0?K(e,t):r.distanceSquared<nn}function q(e,t,n){let r=rn(e,t,n);return r===void 0?K(e,t):r.parameter<-.001||r.parameter>1.001?!1:r.distanceSquared<nn}function on(e,t,n,r){let i=A.sub(r,n);if(A.len(i)===0)return!1;let a=A.normalize(i),o=A.sub(e,n);if(A.len(A.cross(a,o))>en)return!1;let s=A.sub(t,n);return A.len(A.cross(a,s))<=en}function sn(e,t){for(let n of t)if(e>n.start+1e-6&&e<n.end-1e-6)return!0;return!1}function cn(e,t,n){for(let r of n)if(e>=r.start-1e-6&&t<=r.end+1e-6)return!0;return!1}function ln(e,t){for(let n of t)if(Math.abs(e-n)<1e-6)return!0;return!1}function un(e){let t=[];for(let n of e)(t.length===0||Math.abs(n-t[t.length-1])>1e-6)&&t.push(n);return t}function dn(e){if(e.length===0)return[];let t=[...e].sort((e,t)=>e.start-t.start),n=[t[0]];for(let e=1;e<t.length;e++){let r=t[e],i=n[n.length-1];r.start<=i.end+1e-6?n[n.length-1]={start:i.start,end:Math.max(i.end,r.end)}:n.push(r)}return n}var fn={isSolved:!1,solutionVertexPositions:[],solutionLineRanges:[],solutionInfiniteLineAnchors:[],solutionFaces:[]};function pn(e,t){let n=e.vertices??[],r=e.lines??[],i=e.faces??[],a=i.flatMap(e=>e.map((t,n)=>[t,e[(n+1)%e.length]])),o=[...r,...a];if(n.length===0&&o.length===0)return fn;for(let e of n)if(!t.vertices.some(t=>K(t.position,e)))return fn;for(let[e,n]of o)if(!t.lines.some(t=>mn(t,e,n)))return fn;let s=i.flat(),c=r.flat();return{isSolved:!0,solutionVertexPositions:[...n,...c,...s],solutionLineRanges:o,solutionInfiniteLineAnchors:r,solutionFaces:i}}function mn(e,t,n){switch(e.kind){case`line`:case`edge-extended`:case`segment-extended`:return an(t,e.pointA,e.pointB)&&an(n,e.pointA,e.pointB);case`edge`:case`segment`:return q(t,e.pointA,e.pointB)&&q(n,e.pointA,e.pointB);default:b(e.kind)}}function hn(e,t,n,r){return q(e,n,r)&&q(t,n,r)}var J={type:`none`},gn=1e-4;function _n(e,t,n,r,i,a){let o=Tn(e,n,r,a);return{segments:Dn(e,t,n,r,i,a).map(e=>Cn(e)),markers:o,solutionFace:yn(a)}}var vn=7;function yn(e){if(!e?.isSolved)return;let t=e.solutionFaces??[];if(t.length===0)return;let n=V(F,`face`,[`solution`]),[r,i,a]=B(n.color),o=n.alpha,s=0;for(let e of t)e.length>=3&&(s+=e.length-2);if(s===0)return;let c=s*3,l=new Float32Array(c*vn),u=0,d=e=>{l[u]=e[0],l[u+1]=e[1],l[u+2]=e[2],l[u+3]=r,l[u+4]=i,l[u+5]=a,l[u+6]=o,u+=vn};for(let e of t){if(e.length<3)continue;let t=e[0];for(let n=1;n<e.length-1;n++)d(t),d(e[n]),d(e[n+1])}return{vertices:l,vertexCount:c}}function bn(e,t){let[n,r]=e.edges[t];return[e.vertices[n],e.vertices[r]]}function xn(e,t,n,r,i,a){return{startPosition:e,endPosition:t,modifiers:n,lineId:r,startVertexIndex:i,endVertexIndex:a}}function Sn(e){let[t,n,r]=B(e.color);return{width:e.width,color:[t,n,r],alpha:e.alpha,lineType:e.line.type===`dashed`?1:0,dash:e.line.type===`dashed`?e.line.dash:0,gap:e.line.type===`dashed`?e.line.gap:0}}function Cn(e){let t=V(F,`line`,e.modifiers),n=V(F,`line`,[`hidden`,...e.modifiers]);return{startPosition:e.startPosition,endPosition:e.endPosition,visibleStyle:Sn(t),hiddenStyle:Sn(n),lineId:e.lineId,startVertexIndex:e.startVertexIndex,endVertexIndex:e.endVertexIndex}}function wn(e){let[t,n,r]=B(e.color),[i,a,o]=B(e.strokeColor);return{size:e.size,color:[t,n,r],alpha:e.alpha,strokeColor:[i,a,o],strokeWidth:e.strokeWidth}}function Tn(e,t,n,r){let i=[];for(let a=0;a<t.length;a++){let o=t[a],s=o.position,c=[];o.kind===`input`&&c.push(`input`),(L(s,e.vertices,1e-10)||e.figureFaceTriangles.some(t=>Fe(s,t,e.vertices)))&&c.push(`inner`),Fn(o,n)&&c.push(`selected`),r?.isSolved&&r.solutionVertexPositions.some(e=>L(s,[e],1e-10))&&c.push(`solution`);let l=V(F,`vertex`,c),u=V(F,`vertex`,[`hidden`,...c]);i.push({position:s,markerType:l.markerType===`circle`?1:0,visibleStyle:wn(l),hiddenStyle:wn(u),vertexIndex:a})}return i}var En=-2;function Dn(e,t,n,r,i,a){let o=jn(r),s=Mn(r,t,e),c=[];for(let r of t){if(r.kind===`edge`)continue;let t=zn(r,e,n),i=o!==void 0&&r.lineId===o,s=r.kind===`line`||r.kind===`edge-extended`||r.kind===`segment-extended`,l=s&&a?.isSolved===!0&&a.solutionInfiniteLineAnchors.some(([e,t])=>mn(r,e,t));for(let e of t){let t=e.modifiers.includes(`segment`);if(s&&t&&r.kind!==`edge-extended`)continue;let n=[...e.modifiers];r.kind===`edge-extended`&&t&&!n.includes(`edge`)&&n.push(`edge`),r.isInput&&r.kind!==`edge-extended`&&(r.kind===`segment-extended`?Pn(e,r.pointA,r.pointB)&&n.push(`input`):n.push(`input`)),r.kind===`segment`&&!n.includes(`segment`)&&n.push(`segment`),i&&n.push(`selected`),(l||On(e,a))&&n.push(`solution`),c.push({...e,modifiers:n})}}if(i!==void 0){let t=zn({lineId:En,pointA:i.pointA,pointB:i.pointB,kind:`line`,isInput:!1,startVertexId:-1,endVertexId:-1},e,n);for(let e of t)e.modifiers.includes(`segment`)||c.push({...e,modifiers:[...e.modifiers,`preview`]})}return kn([...Ln(e,t,n,s,a),...c])}function On(e,t){return t?.isSolved?t.solutionLineRanges.some(([t,n])=>hn(e.startPosition,e.endPosition,t,n)):!1}function kn(e){let t=new Map;for(let n of e){let e=An(n.startPosition,n.endPosition),r=t.get(e);(r===void 0||n.modifiers.length>r.modifiers.length)&&t.set(e,n)}return[...t.values()]}var Y=6;function An(e,t){let n=`${e[0].toFixed(Y)},${e[1].toFixed(Y)},${e[2].toFixed(Y)}`,r=`${t[0].toFixed(Y)},${t[1].toFixed(Y)},${t[2].toFixed(Y)}`;return n<r?`${n}|${r}`:`${r}|${n}`}function jn(e){switch(e.type){case`line`:return e.lineId;case`none`:return;default:b(e)}}function Mn(e,t,n){let r=new Set;switch(e.type){case`line`:{let i=e.lineId;for(let e of t)if(e.lineId===i)for(let t=0;t<n.edges.length;t++){let[i,a]=bn(n,t);(e.kind===`line`?on(i,a,e.pointA,e.pointB):Nn(i,a,e.pointA,e.pointB))&&r.add(t)}break}case`none`:break;default:b(e)}return r}function Nn(e,t,n,r){return K(e,n)&&K(t,r)||K(e,r)&&K(t,n)}function Pn(e,t,n){let r=[(e.startPosition[0]+e.endPosition[0])/2,(e.startPosition[1]+e.endPosition[1])/2,(e.startPosition[2]+e.endPosition[2])/2],i=rn(r,t,n);if(i===void 0)return K(r,t);let a=.001;return i.parameter>=-a&&i.parameter<=1+a}function Fn(e,t){switch(t.type){case`none`:return!1;case`line`:return e.crossLineIds.includes(t.lineId);default:b(t)}}var In=-1;function Ln(e,t,n,r,i){let a=[],o=Rn(e,t),s=new Map;for(let e=0;e<n.length;e++)s.set(n[e].vertexId,e);let c=(e,t,n,r,o)=>{let s=[...n];i?.isSolved&&i.solutionLineRanges.some(([n,r])=>hn(e,t,n,r))&&s.push(`solution`),a.push(xn(e,t,s,In,r,o))};for(let t=0;t<e.edges.length;t++){let[i,a]=e.edges[t],l=e.vertices[i],u=e.vertices[a],d=o.get(t);if(d?.kind===`edge-extended`)continue;let f=[`edge`,`segment`];r.has(t)&&f.push(`selected`);let p=d===void 0?-1:s.get(d.startVertexId)??-1,m=d===void 0?-1:s.get(d.endVertexId)??-1,h=A.sub(u,l),g=A.dot(h,h);if(g<1e-6||d===void 0){c(l,u,f,p,m);continue}let _=[];for(let e=0;e<n.length;e++){let t=n[e];if(t.vertexId===d.startVertexId||t.vertexId===d.endVertexId||!t.crossLineIds.includes(d.lineId))continue;let r=A.sub(t.position,l),i=A.dot(r,h)/g;i<=1e-6||i>=.999999||_.push({parameter:i,markerIndex:e})}if(_.length===0){c(l,u,f,p,m);continue}_.sort((e,t)=>e.parameter-t.parameter);let v=l,y=p;for(let e of _){let t=A.addScaled(l,h,e.parameter);c(v,t,f,y,e.markerIndex),v=t,y=e.markerIndex}c(v,u,f,y,m)}return a}function Rn(e,t){let n=new Map,r=t.filter(e=>e.kind===`edge`||e.kind===`edge-extended`);for(let t=0;t<e.edges.length;t++){let[i,a]=e.edges[t],o=e.vertices[i],s=e.vertices[a];for(let e of r)if(Nn(o,s,e.pointA,e.pointB)){n.set(t,e);break}}return n}function zn(e,t,n){let[r,i]=e.kind===`segment`||e.kind===`edge`?[e.pointA,e.pointB]:Ne(e.pointA,e.pointB),a=A.sub(i,r),o=A.len(a);if(o===0)return[];let s=A.normalize(a),c=Bn(e,t),l=Vn(r,s,o,t),u=Hn(r,s,o,t),d=c.map(e=>{let[n,i]=bn(t,e),a=X(n,r,s,o),c=X(i,r,s,o);return{start:Math.min(a,c),end:Math.max(a,c)}}),f=X(e.pointA,r,s,o),p=X(e.pointB,r,s,o),m=new Set;m.add(0),m.add(1),m.add(f),m.add(p);for(let e of l)m.add(e);for(let e of u)m.add(e.start),m.add(e.end);for(let e of d)m.add(e.start),m.add(e.end);let h=new Map;for(let e=0;e<n.length;e++){let t=n[e].position,i=X(t,r,s,o),a=Z(i,r,s,o);A.distSq(t,a)<1e-8&&(h.set(i,e),i>1e-6&&i<.999999&&m.add(i))}let g=un([...m].sort((e,t)=>e-t)),_=dn(u),v=[];for(let n=0;n<g.length-1;n++){let i=g[n],a=g[n+1];if(a-i<1e-6)continue;let c=(i+a)/2,l=Z(i,r,s,o),u=Z(a,r,s,o),f=Wn(i,h),p=Wn(a,h);if(cn(i,a,d)){v.push(xn(l,u,[`segment`],e.lineId,f,p));continue}if(sn(c,_)){v.push(xn(l,u,[`inner`],e.lineId,f,p));continue}let m=Z(c,r,s,o),y=t.figureFaceTriangles.some(e=>Fe(m,e,t.vertices));v.push(xn(l,u,y?[`inner`]:[],e.lineId,f,p))}return v}function X(e,t,n,r){return A.dot(A.sub(e,t),n)/r}function Z(e,t,n,r){return A.addScaled(t,n,e*r)}function Bn(e,t){let n=[];for(let r=0;r<t.edges.length;r++){let[i,a]=bn(t,r);on(i,a,e.pointA,e.pointB)&&n.push(r)}return n}function Vn(e,t,n,r){let i=[];for(let a of r.faceTriangles){let o=r.vertices[a[0]],s=r.vertices[a[1]],c=r.vertices[a[2]],l=ze(e,t,o,s,c);if(l!==void 0&&l>0){let e=l/n;e>1e-6&&e<.999999&&!ln(e,i)&&i.push(e)}}return i}function Hn(e,t,n,r){let i=[];for(let a=0;a<r.faces.length;a++){let o=r.faces[a];if(o.length<3)continue;let s=o.map(e=>r.vertices[e]),c=A.sub(s[1],s[0]),l=A.sub(s[2],s[0]),u=A.cross(c,l);if(A.len(u)<1e-6)continue;let d=A.normalize(u);if(Math.abs(A.dot(t,d))>gn)continue;let f=A.dot(A.sub(e,s[0]),d);if(Math.abs(f)>gn)continue;let p=Un(e,t,n,s);p!==void 0&&i.push(p)}return i}function Un(e,t,n,r){let i=0,a=1,o=A.sub(r[1],r[0]),s=A.sub(r[2],r[0]),c=A.cross(o,s);for(let o=0;o<r.length;o++){let s=(o+1)%r.length,l=r[o],u=r[s],d=A.sub(u,l),f=A.cross(c,d);if(A.len(f)<1e-6)continue;let p=A.normalize(f),m=A.dot(A.sub(e,l),p),h=A.dot(t,p)*n;if(Math.abs(h)<1e-6){if(m<-1e-6)return;continue}let g=-m/h;if(h<0?a=Math.min(a,g):i=Math.max(i,g),i>a)return}if(!(a-i<1e-6))return{start:i,end:a}}function Wn(e,t){let n=t.get(e);if(n!==void 0)return n;for(let[n,r]of t)if(Math.abs(e-n)<1e-6)return r;return-1}var Gn=1e-4,Kn=1e-5;function qn(e,t,n){let r=t?.vertices?.map(e=>[e[0],e[1],e[2]])??[],i=0,a=e.edges.map(([t,n])=>({lineId:i++,pointA:e.vertices[t],pointB:e.vertices[n],kind:`edge`,isInput:!0,startVertexId:-1,endVertexId:-1})),o=t?.lines?.map(([e,t])=>({lineId:i++,pointA:[e[0],e[1],e[2]],pointB:[t[0],t[1],t[2]],kind:`line`,isInput:!0,startVertexId:-1,endVertexId:-1}))??[],s=t?.segments?.map(([e,t])=>({lineId:i++,pointA:[e[0],e[1],e[2]],pointB:[t[0],t[1],t[2]],kind:`segment`,isInput:!0,startVertexId:-1,endVertexId:-1}))??[],c=[...a,...o,...s];return Q({figures:[e],lines:c,vertices:[],intersections:[],nextLineId:i,nextVertexId:0},e,r,n)}function Jn(e,t,n,r,i){let a=nr(e,t,n);if(a!==void 0)return a.kind===`edge`||a.kind===`segment`?Xn(e,a.lineId,r,i):e;let o={lineId:e.nextLineId,pointA:t,pointB:n,kind:`line`,isInput:!1,startVertexId:-1,endVertexId:-1};return Q({...e,lines:[...e.lines,o],nextLineId:e.nextLineId+1},r,Qn(e),i)}function Yn(e,t,n,r){let i=e.lines.find(e=>e.lineId===t);return i===void 0||i.isInput?e:Q({...e,lines:e.lines.filter(e=>e.lineId!==t)},n,Qn(e),r)}function Xn(e,t,n,r){let i=e.lines.find(e=>e.lineId===t);if(i===void 0||i.kind!==`edge`&&i.kind!==`segment`)return e;let a=i.kind===`edge`?`edge-extended`:`segment-extended`,o=e.lines.map(e=>e.lineId===t?{...e,kind:a}:e);return Q({...e,lines:o},n,Qn(e),r)}function Zn(e,t,n,r){let i=e.lines.find(e=>e.lineId===t);if(i===void 0||i.kind!==`edge-extended`&&i.kind!==`segment-extended`)return e;let a=i.kind===`edge-extended`?`edge`:`segment`,o=e.lines.map(e=>e.lineId===t?{...e,kind:a}:e);return Q({...e,lines:o},n,Qn(e),r)}function Qn(e){return e.vertices.filter(e=>e.kind===`input`).map(e=>e.position)}function Q(e,t,n,r){let i=r?r.compute(e.lines,t):it(e.lines,t),{vertices:a,nextVertexId:o}=$n(t,n,i,e.nextVertexId),s=ir(e.lines,a),c=er(a,s,i);return{...e,lines:s,intersections:i,vertices:c,nextVertexId:o}}function $n(e,t,n,r){let i=r,a=e.vertices.map(e=>({vertexId:i++,position:e,kind:`figure`,crossLineIds:[]})),o=t.filter(t=>!L(t,e.vertices,Kn)).map(e=>({vertexId:i++,position:e,kind:`input`,crossLineIds:[]})),s=[...e.vertices,...o.map(e=>e.position)],c=n.filter(e=>!L(e.position,s,Kn)).map(e=>({vertexId:i++,position:e.position,kind:`intersection`,crossLineIds:[]}));return{vertices:[...a,...o,...c],nextVertexId:i}}function er(e,t,n){let r=new Map;for(let e of n){let t=rr(e.position),n=r.get(t);if(n!==void 0)for(let t of e.sourceLineIds)n.includes(t)||n.push(t);else r.set(t,[...e.sourceLineIds])}return e.map(e=>{let n;switch(e.kind){case`intersection`:{let t=rr(e.position);n=r.get(t)??[];break}case`figure`:case`input`:{let i=[];for(let n of t)(n.startVertexId===e.vertexId||n.endVertexId===e.vertexId||tr(e.position,n))&&i.push(n.lineId);let a=rr(e.position),o=r.get(a);if(o!==void 0)for(let e of o)i.includes(e)||i.push(e);n=i;break}default:b(e.kind)}return{...e,crossLineIds:n}})}function tr(e,t){return t.kind===`edge`||t.kind===`segment`?q(e,t.pointA,t.pointB):an(e,t.pointA,t.pointB)}function nr(e,t,n){for(let r of[t,n]){let i=e.vertices.find(e=>ar(e.position,r));if(i===void 0||i.crossLineIds.length===0)continue;let a=r===t?n:t;for(let t of i.crossLineIds){let n=e.lines.find(e=>e.lineId===t);if(n!==void 0&&an(a,n.pointA,n.pointB))return n}}}function rr(e){return`${e[0].toFixed(6)},${e[1].toFixed(6)},${e[2].toFixed(6)}`}function ir(e,t){return e.map(e=>{let n=-1,r=-1;for(let i of t)if(n===-1&&ar(i.position,e.pointA)&&(n=i.vertexId),r===-1&&ar(i.position,e.pointB)&&(r=i.vertexId),n!==-1&&r!==-1)break;return{...e,startVertexId:n,endVertexId:r}})}function ar(e,t){return A.distSq(e,t)<Gn}var or=[`vertex`];function sr(e,t){let n=!1,r,{topology:i}=Ee(t),a=Ce(e,t.camera),o=new y(10),s=new rt,c,l=qn(i,t.input,s),u=J,d,f=Me(),p=new Set,m=new Set;function h(){for(let e of p)e(f.canUndo(),f.canRedo())}function g(e){let n=pn(t.expected,e),r=_n(i,e.lines,e.vertices,u,d,n);c?.applySceneState(r)}function _(e){f.push(l),l=e,g(l),h()}function v(){if(!(n||!c))return{canvasWidth:e.clientWidth,canvasHeight:e.clientHeight,devicePixelRatio:Math.max(1,window.devicePixelRatio),mvpMatrix:c.getLastMvpMatrix()}}function x(e,t,n){let r=v();if(r!==void 0)return Ve(e,t,r.canvasWidth,r.canvasHeight,r.devicePixelRatio,r.mvpMatrix,l.lines,l.vertices.map(e=>e.position),n)}function S(e,t){let n=x(e,t);return n?.type===`line`?{type:`line`,lineId:n.lineId}:J}function C(e,t){let n=x(e,t);if(n===void 0)return;if(n.type===`vertex`)return{kind:`vertex`,position:n.position};let r=l.lines.find(e=>e.lineId===n.lineId);if(r===void 0)return;let i=A.sub(r.pointB,r.pointA);return{kind:`line`,lineId:n.lineId,direction:[i[0],i[1],i[2]],planeAnchor:r.pointA}}function w(e,t){let n=x(e,t,or);return n?.type===`vertex`?n.position:void 0}function T(e){u=e,g(l)}function E(){switch(u.type){case`line`:{let e=u.lineId,t=l.lines.find(t=>t.lineId===e);return t===void 0?void 0:A.sub(t.pointB,t.pointA)}case`none`:return;default:b(u)}}function D(e,t){T(S(e,t))}function O(e){let t=l.lines.find(t=>t.lineId===e);if(t!==void 0)switch(u=J,t.kind){case`edge`:case`segment`:_(Xn(l,e,i,s));break;case`edge-extended`:case`segment-extended`:_(Zn(l,e,i,s));break;case`line`:_(Yn(l,e,i,s));break;default:b(t.kind)}}function k(){o.raise(60)}e.addEventListener(`pointerdown`,k),e.addEventListener(`pointermove`,k),e.addEventListener(`wheel`,k);let j=we(e,D,()=>{}),M=Te(e,{performInitialHitTest:C,performSnapHitTest:w,hasActiveSelection:()=>u.type!==`none`,isLineSelected:e=>u.type===`line`&&u.lineId===e,onDragStart:()=>{},onDragUpdate:e=>{c?.setDragPreview(e),d=c?.getPreviewLine(),g(l)},onLineTap:e=>T({type:`line`,lineId:e}),onLineDoubleTap:O,onVertexTap:e=>{let t=E();if(t!==void 0){let n=[e[0]+t[0],e[1]+t[1],e[2]+t[2]];_(Jn(l,e,n,i,s))}T(J)},onDragComplete:(e,t)=>{_(Jn(l,e,t,i,s)),T(J)},onSecondPointer:(e,t,n)=>{a.registerExternalPointer(e,t,n)}});cr(e,a,i,t,o,e=>{for(let t of m)t(e)}).then(({cleanup:e,sceneLayer:t})=>{n?e():(r=e,c=t,g(l))});function ee(e){e!==void 0&&(l=e,g(l),T(J),h())}return{destroy:()=>{n=!0,a.destroy(),o.dispose(),e.removeEventListener(`pointerdown`,k),e.removeEventListener(`pointermove`,k),e.removeEventListener(`wheel`,k),j(),M(),p.clear(),m.clear(),r?.()},camera:a,undo:()=>ee(f.undo(l)),redo:()=>ee(f.redo(l)),subscribeHistory:e=>(p.add(e),e(f.canUndo(),f.canRedo()),()=>p.delete(e)),subscribeFps:e=>(m.add(e),()=>m.delete(e))}}async function cr(e,t,n,r,i,a){let o=await O(e),s=_(4),c=new Jt(t,s,n,i,r.camera?.center??[0,0,0],r.camera?.projection??`perspective`),l=new k([c]);l.initAll(o);let u=$t({canvas:e,context:o,layerManager:l,fpsController:i,onFpsUpdate:a});return{cleanup:()=>{u(),l.dispose(),s.dispose(),o.device.destroy()},sceneLayer:c}}var $=t(),lr=(0,P.memo)(()=>{let[e,t]=(0,P.useState)(!1);return(0,$.jsxs)(T,{open:e,onOpenChange:t,children:[(0,$.jsx)(x,{title:N.toolbar.help,delayDuration:300,children:(0,$.jsx)(D,{asChild:!0,children:(0,$.jsx)(`button`,{type:`button`,"aria-label":N.toolbar.help,className:r(`flex size-10 items-center justify-center rounded-lg shadow-lg`,`transition-all hover:scale-110 active:scale-95`,e?`bg-blue-500 text-white scale-110`:`bg-neutral-800 text-neutral-400 hover:text-white`),children:(0,$.jsx)(o,{size:20})})})}),(0,$.jsx)(S,{children:(0,$.jsxs)(C,{side:`top`,sideOffset:8,align:`end`,collisionPadding:16,className:r(`z-50 w-72 max-h-[calc(100dvh-6rem)] overflow-y-auto rounded-lg bg-neutral-900 p-4 text-sm text-neutral-200 shadow-xl`,`border border-neutral-700`,`data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95`,`data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95`),children:[(0,$.jsxs)(`div`,{className:`mb-2 flex items-center justify-between`,children:[(0,$.jsx)(`span`,{className:`font-semibold text-white`,children:N.help.title}),(0,$.jsx)(E,{"aria-label":N.toolbar.close,className:`text-neutral-500 hover:text-white transition-colors`,children:(0,$.jsx)(l,{size:14})})]}),(0,$.jsx)(`p`,{className:`mb-3 text-neutral-400`,children:N.help.description}),(0,$.jsxs)(`ul`,{className:`space-y-1.5 text-neutral-300`,children:[(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{className:`text-neutral-100`,children:N.help.controlLabels.drag}),` —`,` `,N.help.controls.drag]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{className:`text-neutral-100`,children:N.help.controlLabels.shiftDrag}),` `,`— `,N.help.controls.shiftDrag]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{className:`text-neutral-100`,children:N.help.controlLabels.scrollPinch}),` `,`— `,N.help.controls.scrollPinch]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{className:`text-neutral-100`,children:N.help.controlLabels.clickEdge}),` `,`— `,N.help.controls.clickEdge]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{className:`text-neutral-100`,children:N.help.controlLabels.doubleClickEdge}),` `,`— `,N.help.controls.doubleClickEdge]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{className:`text-neutral-100`,children:N.help.controlLabels.doubleClickLine}),` `,`— `,N.help.controls.doubleClickLine]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{className:`text-neutral-100`,children:N.help.controlLabels.dragVertex}),` `,`— `,N.help.controls.dragVertex]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{className:`text-neutral-100`,children:N.help.controlLabels.selectEdgeTapVertex}),` `,`— `,N.help.controls.selectEdgeTapVertex]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`strong`,{className:`text-neutral-100`,children:N.help.controlLabels.holdDragLineVertex}),` `,`— `,N.help.controls.holdDragLineVertex]})]}),(0,$.jsx)(`p`,{className:`mt-3 text-xs text-neutral-500`,children:N.help.intersectionHint}),(0,$.jsx)(w,{className:`fill-neutral-900`})]})})]})}),ur=(0,P.memo)(({puzzle:e})=>{let[t,n]=(0,P.useState)(!1),i=N.puzzles[e.id];return i===void 0?null:(0,$.jsxs)(T,{open:t,onOpenChange:n,children:[(0,$.jsx)(x,{title:N.toolbar.puzzle,delayDuration:300,children:(0,$.jsx)(D,{asChild:!0,children:(0,$.jsx)(`button`,{type:`button`,"aria-label":N.toolbar.puzzle,className:r(`flex size-10 items-center justify-center rounded-lg shadow-lg`,`transition-all hover:scale-110 active:scale-95`,t?`bg-blue-500 text-white scale-110`:`bg-neutral-800 text-neutral-400 hover:text-white`),children:(0,$.jsx)(re,{size:20})})})}),(0,$.jsx)(S,{children:(0,$.jsxs)(C,{side:`top`,sideOffset:8,align:`end`,collisionPadding:16,className:r(`z-50 w-72 max-h-[calc(100dvh-6rem)] overflow-y-auto rounded-lg bg-neutral-900 p-4 text-sm text-neutral-200 shadow-xl`,`border border-neutral-700`,`data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95`,`data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95`),children:[(0,$.jsxs)(`div`,{className:`mb-2 flex items-center justify-between`,children:[(0,$.jsx)(`span`,{className:`font-semibold text-white`,children:i.name}),(0,$.jsx)(E,{"aria-label":N.toolbar.close,className:`text-neutral-500 hover:text-white transition-colors`,children:(0,$.jsx)(l,{size:14})})]}),e.solutionImage!==void 0&&(0,$.jsx)(`img`,{src:e.solutionImage,alt:N.solutionImageAlt,className:`mb-3 w-full rounded-md border border-neutral-700 object-cover`}),(0,$.jsx)(`p`,{className:`text-neutral-300`,children:i.description}),(0,$.jsx)(w,{className:`fill-neutral-900`})]})})]})}),dr=(0,P.memo)(({active:e=!1,disabled:t=!1,onClick:n,children:i,label:a,tooltipDelayMs:o=300})=>(0,$.jsx)(x,{title:a,delayDuration:o,children:(0,$.jsx)(`button`,{type:`button`,onClick:n,disabled:t,"aria-label":a,"aria-pressed":e,className:r(`flex size-10 items-center justify-center rounded-lg shadow-lg`,`transition-all`,t?`bg-neutral-900 text-neutral-600 cursor-not-allowed`:`hover:scale-110 active:scale-95`,!t&&e&&`bg-blue-500 text-white`,!t&&!e&&`bg-neutral-800 text-neutral-400 hover:text-white`),children:i})})),fr=te(),pr=(0,P.memo)(({puzzle:e})=>{let t=(0,P.useRef)(null),n=(0,P.useRef)(null),[r,a]=(0,P.useState)(`rotate`),[o,l]=(0,P.useState)(!1),[u,d]=(0,P.useState)(!1),[p,h]=(0,P.useState)(0),_=f(),v=i(()=>{_(`/stereometry`)});m({label:N.nav.backToPuzzlesLabel,onActivate:v}),(0,P.useEffect)(()=>{if(t.current){let r=sr(t.current,e);n.current=r;let i=r.subscribeHistory((e,t)=>{l(e),d(t)}),a=r.subscribeFps(h);return()=>{n.current=null,i(),a(),r.destroy()}}},[e]);let y=i(()=>{a(`rotate`),n.current?.camera.setInteractionMode(`rotate`)}),b=i(()=>{a(`pan`),n.current?.camera.setInteractionMode(`pan`)}),x=i(()=>{n.current?.undo()}),S=i(()=>{n.current?.redo()});return(0,$.jsx)(g,{className:`h-full w-full`,children:(0,$.jsxs)(`div`,{className:`h-full w-full`,children:[(0,$.jsx)(`canvas`,{ref:t,className:`h-full w-full [touch-action:none]`}),!fr&&(0,$.jsxs)(`div`,{className:`absolute top-3 right-3 rounded bg-black/60 px-2 py-0.5 font-mono text-xs text-neutral-400`,children:[p,` FPS`]}),(0,$.jsxs)(`div`,{className:`fixed right-4 bottom-4 flex gap-2`,children:[(0,$.jsx)(ur,{puzzle:e}),(0,$.jsx)(lr,{}),(0,$.jsx)(dr,{onClick:x,label:N.toolbar.undo,disabled:!o,children:(0,$.jsx)(c,{size:20})}),(0,$.jsx)(dr,{onClick:S,label:N.toolbar.redo,disabled:!u,children:(0,$.jsx)(ie,{size:20})}),(0,$.jsx)(dr,{active:r===`rotate`,onClick:y,label:N.toolbar.rotate,children:(0,$.jsx)(s,{size:20})}),(0,$.jsx)(dr,{active:r===`pan`,onClick:b,label:N.toolbar.pan,children:(0,$.jsx)(ne,{size:20})})]})]})})}),mr=(0,P.memo)(()=>{let{puzzleId:e}=d(),t=ee(e);return p(t)?(0,$.jsx)(h,{to:`/stereometry`,replace:!0}):(0,$.jsx)(pr,{puzzle:t})});export{mr as Stereometry};