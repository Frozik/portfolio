import{G as e,J as t,M as n,X as r,Y as i,_t as a,a as o,ft as s,gt as c,ht as l,i as u,j as d,pt as f,q as p,s as m,t as h,wt as g}from"./c-BUiHm-Fm.js";import{a as _,c as v,d as y,f as b,h as x,i as ee,l as te,m as ne,n as re,o as ie,p as ae,r as oe,s as S,t as se,u as ce}from"./c-u2NfgT8F.js";import{D as le,O as C,S as ue,T as de,_ as w,h as fe,i as T,k as pe,n as me,p as he,r as ge,t as _e,v as E,y as D}from"./c-CNss2Yir.js";import{J as ve,K as O,W as ye,c as k,q as be,z as A}from"./c-WiH5uk4Z.js";import{o as xe,u as j}from"./c-lXEZjRPz.js";import{t as Se}from"./e-BDkPeIqc.js";import{t as M}from"./c-DQ_Vhre8.js";import{t as Ce}from"./c-CzYv-hUz.js";import{n as we,t as Te}from"./c-CDQujcbc.js";var Ee=`[object String]`;function De(e){return typeof e==`string`||!f(e)&&c(e)&&a(e)==Ee}var Oe=4294967294,ke=Math.floor,Ae=Math.min;function je(e,t,n,r){var i=0,a=e==null?0:e.length;if(a===0)return 0;t=n(t);for(var o=t!==t,s=t===null,c=l(t),u=t===void 0;i<a;){var d=ke((i+a)/2),f=n(e[d]),p=f!==void 0,m=f===null,h=f===f,g=l(f);if(o)var _=r||h;else _=u?h&&(r||p):s?h&&p&&(r||!m):c?h&&p&&!m&&(r||!g):m||g?!1:r?f<=t:f<t;_?i=d+1:a=d}return Ae(a,Oe)}function Me(e,t,n){return je(e,t,pe(n,2))}function N(e,t){var n=C(e)?e:function(){return e},r=function(e){return e.error(n())};return new D(t?function(e){return t.schedule(r,0,e)}:r)}var Ne=le(function(e){return function(t){t===void 0&&(t=null),e(this),this.message=`Timeout has occurred`,this.name=`TimeoutError`,this.info=t}});function Pe(e,t){var n=ge(e)?{first:e}:typeof e==`number`?{each:e}:e,r=n.first,i=n.each,a=n.with,o=a===void 0?Fe:a,s=n.scheduler,c=s===void 0?t??fe:s,l=n.meta,u=l===void 0?null:l;if(r==null&&i==null)throw TypeError(`No timeout provided.`);return E(function(e,t){var n,a,s=null,l=0,d=function(e){a=ce(t,c,function(){try{n.unsubscribe(),T(o({meta:u,lastValue:s,seen:l})).subscribe(t)}catch(e){t.error(e)}},e)};n=e.subscribe(w(t,function(e){a?.unsubscribe(),l++,t.next(s=e),i>0&&d(i)},void 0,void 0,function(){a?.closed||a?.unsubscribe(),s=null})),!l&&d(r==null?i:typeof r==`number`?r:+r-c.now())})}function Fe(e){throw new Ne(e)}var Ie=Array.isArray;function Le(e,t){return Ie(t)?e.apply(void 0,ve([],O(t))):e(t)}function Re(e){return S(function(t){return Le(e,t)})}function ze(){return _(1)}function P(){var e=[...arguments];return ze()(te(e,y(e)))}function F(e){return new D(function(t){T(e()).subscribe(t)})}var Be=[`addListener`,`removeListener`],Ve=[`addEventListener`,`removeEventListener`],He=[`on`,`off`];function I(e,t,n,r){if(C(n)&&(r=n,n=void 0),r)return I(e,t,n).pipe(Re(r));var i=O(Ke(e)?Ve.map(function(r){return function(i){return e[r](t,i,n)}}):We(e)?Be.map(Ue(e,t)):Ge(e)?He.map(Ue(e,t)):[],2),a=i[0],o=i[1];if(!a&&he(e))return ie(function(e){return I(e,t,n)})(T(e));if(!a)throw TypeError(`Invalid event target`);return new D(function(e){var t=function(){var t=[...arguments];return e.next(1<t.length?t:t[0])};return a(t),function(){return o(t)}})}function Ue(e,t){return function(n){return function(r){return e[n](t,r)}}}function We(e){return C(e.addListener)&&C(e.removeListener)}function Ge(e){return C(e.on)&&C(e.off)}function Ke(e){return C(e.addEventListener)&&C(e.removeEventListener)}function qe(e,t){return E(function(n,r){var i=0;n.subscribe(w(r,function(n){return e.call(t,n,i++)&&r.next(n)}))})}function Je(e,t,n,r,i){return function(a,o){var s=n,c=t,l=0;a.subscribe(w(o,function(t){var n=l++;c=s?e(c,t,n):(s=!0,t),r&&o.next(c)},i&&(function(){s&&o.next(c),o.complete()})))}}function Ye(e,t){return C(t)?ie(e,t,1):ie(e,1)}function Xe(){var e=[...arguments];return function(t){return P(t,v.apply(void 0,ve([],O(e))))}}function Ze(e){return E(function(t,n){try{t.subscribe(n)}finally{n.add(e)}})}function Qe(e,t){return E(Je(e,t,arguments.length>=2,!0))}var L=g(i(),1),$e=16384,et=8192,tt=1024,nt=.02,rt=.18,it=.95,at=1e3,ot=.1,st=.2,ct=1e3,lt=.45,ut=.35,dt=.2,ft=1024,pt=`#ccc`,R=`#aaa`,mt=`#444`,ht=`monospace`,gt=`#141414`,_t=`#2a2a2a`,vt=`rgba(46, 160, 67, 0.55)`,yt=`rgba(229, 57, 53, 0.55)`,bt=2048,xt=4e4,St=[.08,.5,.18,1],Ct=[.6,.12,.12,1],wt=[0,0,0,1],Tt=`rgba(230, 230, 230, 0.7)`,Et=[4,4],Dt=`#404a63`,Ot=`#ffffff`;function kt(e,t,n){let r=t*n;return Math.floor(e/r)*r}function z(e,t,n){return e+(t-e)*n}function B(e){return Math.max(1,e-150)}function At(e,t){return Math.max(1,e-150*t)}function jt(e){return e>=16384?{textureWidth:$e,rowsPerBlock:1,snapshotsPerRow:128}:{textureWidth:et,rowsPerBlock:2,snapshotsPerRow:64}}var Mt=60*1e3,Nt=3,Pt=1,Ft=4,It=80,Lt=2,Rt=2,V=2,zt=`rgba(26, 26, 26, 0.85)`,H=3,U=2,Bt=[1e3,2*1e3,5*1e3,10*1e3,15*1e3,30*1e3,60*1e3,120*1e3,300*1e3,600*1e3,900*1e3,1800*1e3,3600*1e3];function Vt(e,t){let n=e/Math.max(Lt,Math.floor(t/It));for(let e of Bt)if(e>=n)return e;return Bt[Bt.length-1]}function Ht(e){let t=new Date(e);return`${t.getUTCHours().toString().padStart(V,`0`)}:${t.getUTCMinutes().toString().padStart(V,`0`)}:${t.getUTCSeconds().toString().padStart(V,`0`)}`}function Ut(e){return e>=1?0:Math.min(8,Math.ceil(-Math.log10(e)))}function Wt(e){let t=e.canvasWidthPx/e.devicePixelRatio,n=e.canvasHeightPx/e.devicePixelRatio;return{left:0,right:B(t),top:0,bottom:n}}function Gt(e){let t=e.canvasWidthPx/e.devicePixelRatio,n=e.canvasHeightPx/e.devicePixelRatio;return{left:B(t),right:t,top:0,bottom:n}}function W(e,t,n,r){let i=r-n;if(i<=0)return t.bottom;let a=t.bottom-t.top,o=(e-n)/i;return t.bottom-o*a}function Kt(e){let{ctx:t,devicePixelRatio:n}=e;t.save(),t.scale(n,n);let r=Wt(e);t.strokeStyle=mt,t.lineWidth=1,Jt(t,r,e),Yt(t,r,e),t.restore()}function qt(e){let{ctx:t,devicePixelRatio:n}=e;t.save(),t.scale(n,n);let r=Wt(e),i=Gt(e);t.font=`11px ${ht}`,t.strokeStyle=R,t.lineWidth=1,Xt(t,r,e),Zt(t,i,e),nn(t,r,i,e),t.restore()}function Jt(e,t,n){let{viewTimeStartMs:r,viewTimeEndMs:i}=n,a=t.right-t.left,o=i-r;if(o<=0||a<=0)return;let s=Vt(o,a),c=Math.ceil(r/s)*s;for(let n=c;n<=i;n+=s){let i=(n-r)/o,s=t.left+i*a;e.lineWidth=n%Mt===0?Nt:Pt,e.beginPath(),e.moveTo(s,t.top),e.lineTo(s,t.bottom),e.stroke()}e.lineWidth=Pt}function Yt(e,t,n){let{priceMin:r,priceMax:i,priceStep:a}=n;if(i-r<=0||a<=0)return;let o=Math.ceil((r+a/2)/a)*a;for(let n=o;n<=i+a/2;n+=a){let o=W(n-a/2,t,r,i);e.beginPath(),e.moveTo(t.left,o),e.lineTo(t.right,o),e.stroke()}}function Xt(e,t,n){let{viewTimeStartMs:r,viewTimeEndMs:i}=n,a=t.right-t.left,o=i-r;if(o<=0||a<=0)return;e.beginPath(),e.moveTo(t.left,t.bottom),e.lineTo(t.right,t.bottom),e.stroke(),e.textAlign=`center`,e.textBaseline=`bottom`;let s=Vt(o,a),c=Math.ceil(r/s)*s,l=t.bottom-Ft-U;for(let n=c;n<=i;n+=s){let i=(n-r)/o,s=t.left+i*a;e.strokeStyle=R,e.beginPath(),e.moveTo(s,t.bottom),e.lineTo(s,t.bottom-Ft),e.stroke();let c=Ht(n),u=e.measureText(c);e.fillStyle=zt,e.fillRect(s-u.width/2-H,l-11-U,u.width+2*H,11+2*U),e.fillStyle=pt,e.fillText(c,s,l)}}function Zt(e,t,n){let{priceMin:r,priceMax:i,priceStep:a}=n,o=t.bottom-t.top,s=t.right-t.left,c=i-r;if(o<=0||s<=0||c<=0||a<=0)return;e.fillStyle=gt,e.fillRect(t.left,t.top,s,o),e.strokeStyle=R,e.lineWidth=1,e.beginPath(),e.moveTo(t.left+.5,t.top),e.lineTo(t.left+.5,t.bottom),e.stroke();let l=a/c*o,u=11+2*U,d=l>=u?1:Math.max(1,Math.ceil(u/l)),f=Math.ceil(r/a)*a,p=Math.max(Rt,Ut(a));e.textAlign=`right`,e.textBaseline=`middle`;let m=i.toFixed(p),h=e.measureText(m).width,g=t.left+H+h,_=11+2*U;tn(e,t,n,g+H);let v=0;for(let n=f;n<=i;n+=a,v++){let o=W(n+a/2,t,r,i),s=W(n-a/2,t,r,i);if(e.strokeStyle=_t,e.beginPath(),e.moveTo(t.left,Math.round(o)+.5),e.lineTo(t.right,Math.round(o)+.5),e.stroke(),v%d!==0)continue;let c=(o+s)/2;c<t.top+_/2||c>t.bottom-_/2||(e.fillStyle=pt,e.fillText(n.toFixed(p),g,c))}}function Qt(e){return e>=1e6?`${(e/1e6).toFixed(3)}M`:e>=1e3?`${(e/1e3).toFixed(3)}K`:e.toFixed(2)}var $t=`#ffffff`,en=3;function tn(e,t,n,r){let{lastSnapshot:i,priceMin:a,priceMax:o,priceStep:s}=n;if(i===void 0)return;let c=t.bottom-t.top,l=o-a;if(c<=0||l<=0||s<=0)return;let u=[],d=0;for(let[e,t]of i.bids)t>0&&e>=a&&e<=o&&(u.push({price:e,volume:t,side:`bid`}),t>d&&(d=t));for(let[e,t]of i.asks)t>0&&e>=a&&e<=o&&(u.push({price:e,volume:t,side:`ask`}),t>d&&(d=t));if(u.length===0||d<=0)return;let f=t.right-4,p=Math.max(0,f-r);if(p<=0)return;let m=s/l*c,h=Math.max(2,m>3?m-1:m),g=m>=13;e.save(),e.textAlign=`right`,e.textBaseline=`middle`;for(let n of u){let r=n.volume/d,i=Math.max(2,r*p),s=W(n.price,t,a,o),c=s-h/2;e.fillStyle=n.side===`bid`?vt:yt,e.fillRect(f-i,c,i,h),g&&(e.fillStyle=$t,e.fillText(Qt(n.volume),f-en,s))}e.restore()}function nn(e,t,n,r){let{cursorCss:i,viewTimeStartMs:a,viewTimeEndMs:o,priceMin:s,priceMax:c,priceStep:l}=r;if(i===void 0)return;let u=t.right-t.left,d=t.bottom-t.top,f=o-a,p=c-s;if(u<=0||d<=0||f<=0||p<=0||i.y<t.top||i.y>t.bottom)return;let m=i.x>=t.left&&i.x<=t.right;if(e.save(),e.lineWidth=1,e.strokeStyle=Tt,e.setLineDash([...Et]),e.beginPath(),e.moveTo(t.left,i.y),e.lineTo(n.left,i.y),e.stroke(),m&&(e.beginPath(),e.moveTo(i.x,t.top),e.lineTo(i.x,t.bottom),e.stroke()),e.setLineDash([]),e.font=`11px ${ht}`,m){let n=a+(i.x-t.left)/u*f,r=Math.floor(n/1e3)*1e3;rn(e,t,i.x,Ht(r))}let h=c-(i.y-t.top)/d*p,g=Math.max(Rt,Ut(l));an(e,n,i.y,h,c,g),e.restore()}function rn(e,t,n,r){let i=e.measureText(r).width+2*H,a=11+2*U,o=n-i/2,s=Math.max(t.left,Math.min(t.right-i,o)),c=t.bottom-a;e.fillStyle=Dt,e.fillRect(s,c,i,a),e.fillStyle=Ot,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(r,s+i/2,c+a/2)}function an(e,t,n,r,i,a){let o=r.toFixed(a),s=t.right-t.left,c=11+2*U,l=n-c/2,u=Math.max(t.top,Math.min(t.bottom-c,l));e.fillStyle=Dt,e.fillRect(t.left,u,s,c),e.textAlign=`right`,e.textBaseline=`middle`;let d=i.toFixed(a),f=e.measureText(d).width,p=t.left+H+f;e.fillStyle=Ot,e.fillText(o,p,u+c/2)}var on=9,sn=class{tree=new we(on);byId=new Map;upsert(e){let t=this.byId.get(e.blockId);t!==void 0&&this.tree.remove(t),this.byId.set(e.blockId,e),this.tree.insert(e)}searchRange(e,t){return this.tree.search({minX:e,maxX:t,minY:0,maxY:0}).slice().sort((e,t)=>e.minX-t.minX)}remove(e){let t=this.byId.get(e);t!==void 0&&(this.tree.remove(t),this.byId.delete(e))}get(e){return this.byId.get(e)}oldestStartMs(){let e;for(let t of this.byId.values())(e===void 0||t.minX<e)&&(e=t.minX);return e}all(){return Array.from(this.byId.values())}clear(){this.tree.clear(),this.byId.clear()}get size(){return this.byId.size}},cn=class{items=[];upsert(e){let t=this.findIndex(e.blockId);if(t>=0){let n=this.items[t];n.lastTimestampMs=e.lastTimestampMs,n.count=e.count,n.textureRowIndex=e.textureRowIndex;return}let n=Me(this.items,e,e=>e.firstTimestampMs);this.items.splice(n,0,e)}searchRange(e,t){let n=[];for(let r of this.items)r.lastTimestampMs<e||r.firstTimestampMs>t||n.push(r);return n}get(e){let t=this.findIndex(e);return t>=0?this.items[t]:void 0}remove(e){let t=this.findIndex(e);t>=0&&this.items.splice(t,1)}oldestStartMs(){return this.items.length>0?this.items[0].firstTimestampMs:void 0}all(){return this.items}clear(){this.items.length=0}get size(){return this.items.length}findIndex(e){for(let t=0;t<this.items.length;t++)if(this.items[t].blockId===e)return t;return-1}};function ln(e,t){return{uniformsBuffer:e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:`heatmap.uniforms`}),descriptorsBuffer:e.createBuffer({size:16*Math.max(t,1),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:`heatmap.descriptors`})}}function un(e){return e.createBindGroupLayout({label:`heatmap.bindGroupLayout`,entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:1,visibility:GPUShaderStage.VERTEX,texture:{sampleType:`unfilterable-float`,viewDimension:`2d`}},{binding:2,visibility:GPUShaderStage.VERTEX,buffer:{type:`read-only-storage`}}]})}function dn(e,t,n,r){return e.createBindGroup({label:`heatmap.bindGroup`,layout:t,entries:[{binding:0,resource:{buffer:n.uniformsBuffer}},{binding:1,resource:r},{binding:2,resource:{buffer:n.descriptorsBuffer}}]})}function fn(e){let{device:t,module:n,layout:r,format:i,layoutConfig:a}=e;return{label:`heatmap.pipeline`,layout:t.createPipelineLayout({bindGroupLayouts:[r]}),vertex:{module:n,entryPoint:`vsHeatmap`,constants:{SNAPSHOT_SLOTS:128,SNAPSHOTS_PER_ROW:a.snapshotsPerRow,ROWS_PER_BLOCK:a.rowsPerBlock}},fragment:{module:n,entryPoint:`fsHeatmap`,constants:{STRIPE_PERIOD_PX:8,STRIPE_DARK_FACTOR:lt,CELL_ALPHA_LOW:ut},targets:[{format:i,blend:{color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`},multisample:{count:4}}}function pn(e,t,n){let r=new ArrayBuffer(64),i=new Float32Array(r),a=new Uint32Array(r);i[0]=n.canvasWidth,i[1]=n.canvasHeight,i[2]=n.viewTimeStartDeltaMs,i[3]=n.viewTimeEndDeltaMs,i[4]=n.timeStepMs,i[5]=n.priceStep,i[6]=n.priceMin,i[7]=n.priceMax,i[8]=n.magnitudeMin,i[9]=n.magnitudeMax,a[10]=n.blockCount,i[11]=n.plotWidthPx,e.queue.writeBuffer(t,0,r)}function mn(e,t,n,r){if(p(n.length>0?t.size>=16*n.length:!0,`descriptors buffer too small for visible blocks`),n.length===0)return{totalCells:0,totalInstances:0};let i=16*n.length,a=new ArrayBuffer(i),o=new Uint32Array(a),s=new Float32Array(a),c=0;for(let e=0;e<n.length;e++){let t=n[e],i=t.meta.count*128,a=e*4;o[a+0]=t.textureRowIndex,o[a+1]=t.meta.count,o[a+2]=c,s[a+3]=t.meta.firstTimestampMs-r,c+=i}return e.queue.writeBuffer(t,0,a),{totalCells:c,totalInstances:c}}function hn(e,t){return{uniformsBuffer:e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST,label:`mid-price.uniforms`}),descriptorsBuffer:e.createBuffer({size:16*Math.max(t,1),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,label:`mid-price.descriptors`})}}function gn(e){return e.createBindGroupLayout({label:`mid-price.bindGroupLayout`,entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:1,visibility:GPUShaderStage.VERTEX,texture:{sampleType:`unfilterable-float`,viewDimension:`2d`}},{binding:2,visibility:GPUShaderStage.VERTEX,buffer:{type:`read-only-storage`}}]})}function _n(e,t,n,r){return e.createBindGroup({label:`mid-price.bindGroup`,layout:t,entries:[{binding:0,resource:{buffer:n.uniformsBuffer}},{binding:1,resource:r},{binding:2,resource:{buffer:n.descriptorsBuffer}}]})}function vn(e){let{device:t,module:n,layout:r,format:i,label:a,fragmentEntryPoint:o}=e;return{label:a,layout:t.createPipelineLayout({bindGroupLayouts:[r]}),vertex:{module:n,entryPoint:`vsMidPrice`},fragment:{module:n,entryPoint:o,targets:[{format:i,blend:{color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]},primitive:{topology:`triangle-list`},multisample:{count:4}}}function yn(e){return vn({...e,label:`mid-price.interior.pipeline`,fragmentEntryPoint:`fsMidPriceInterior`})}function bn(e){return vn({...e,label:`mid-price.outline.pipeline`,fragmentEntryPoint:`fsMidPriceOutline`})}function xn(e,t,n){let r=new ArrayBuffer(64),i=new Float32Array(r),a=new Uint32Array(r);i[0]=n.canvasWidth,i[1]=n.canvasHeight,i[2]=n.plotWidthPx,i[3]=n.viewTimeStartDeltaMs,i[4]=n.viewTimeEndDeltaMs,i[5]=n.priceMin,i[6]=n.priceMax,i[7]=10,i[8]=10,i[9]=xt,a[10]=n.blockCount,a[11]=bt,i[12]=4,e.queue.writeBuffer(t,0,r)}function Sn(e,t,n,r){if(p(n.length>0?t.size>=16*n.length:!0,`mid-price: descriptors buffer too small for visible blocks`),n.length===0)return{totalSamples:0,totalSegments:0};let i=16*n.length,a=new ArrayBuffer(i),o=new Uint32Array(a),s=new Float32Array(a),c=0,l=0;for(let e=0;e<n.length;e++){let t=n[e],i=e*4;o[i+0]=t.textureOffset,o[i+1]=t.item.count,s[i+2]=t.item.firstTimestampMs-r,s[i+3]=t.item.basePrice,c+=t.item.count,t.item.count>=2&&(l+=t.item.count-1)}return e.queue.writeBuffer(t,0,a),{totalSamples:c,totalSegments:l}}var Cn=12,wn=`rgba32float`,Tn=GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.COPY_SRC,En=4;Math.floor(bt/256);var Dn=class{device;textureWidth;samplesPerBlock;slotsPerRow;maxRows;onEvict;texture;capacityRows;highWaterMark=0;freeSlots=[];lru;blockToSlot=new Map;constructor(e){this.device=e.device,this.textureWidth=e.textureWidth??2048,this.samplesPerBlock=e.samplesPerBlock??256,this.slotsPerRow=Math.floor(this.textureWidth/this.samplesPerBlock),this.capacityRows=e.initialRows??2,this.maxRows=e.maxRows??2,this.onEvict=e.onEvict,this.texture=this.device.createTexture({size:[this.textureWidth,this.capacityRows],format:wn,usage:Tn}),this.lru=new Te({max:this.capacityBlocks})}allocate(e){let t=this.blockToSlot.get(e);if(t!==void 0)return this.lru.get(t),t;let n=this.popFreeSlot()??this.advanceHighWaterMark()??this.growAndAdvance()??this.evictAndReuseSlot();return this.blockToSlot.set(e,n),this.lru.set(n,e),n}touch(e){let t=this.blockToSlot.get(e);t!==void 0&&this.lru.get(t)}release(e){let t=this.blockToSlot.get(e);t!==void 0&&(this.blockToSlot.delete(e),this.lru.delete(t),this.freeSlots.push(t))}writeSamples(e,t,n,r,i){if(n<=0)return;let{column:a,row:o}=this.slotOriginToTexelCoord(e),s=this.textureWidth*En*Float32Array.BYTES_PER_ELEMENT,c=n*En;this.device.queue.writeTexture({texture:this.texture,origin:{x:a+t,y:o,z:0}},r.subarray(i,i+c),{bytesPerRow:s,rowsPerImage:1},{width:n,height:1,depthOrArrayLayers:1})}slotTextureOffset(e){let{row:t,column:n}=this.slotOriginToTexelCoord(e);return t*this.textureWidth+n}createView(){return this.texture.createView()}get currentCapacityBlocks(){return this.capacityBlocks}get currentAllocatedBlocks(){return this.blockToSlot.size}dispose(){this.texture.destroy(),this.lru.clear(),this.blockToSlot.clear(),this.freeSlots.length=0}get capacityBlocks(){return this.capacityRows*this.slotsPerRow}slotOriginToTexelCoord(e){return{row:Math.floor(e/this.slotsPerRow),column:e%this.slotsPerRow*this.samplesPerBlock}}popFreeSlot(){return this.freeSlots.pop()}advanceHighWaterMark(){if(this.highWaterMark>=this.capacityBlocks)return;let e=this.highWaterMark;return this.highWaterMark++,e}growAndAdvance(){if(this.capacityRows>=this.maxRows)return;let e=Math.min(this.capacityRows*2,this.maxRows);this.growTexture(e);let t=this.highWaterMark;return this.highWaterMark++,t}evictAndReuseSlot(){let e=this.lru.rkeys().next().value;if(e===void 0)throw Error(`MidPriceTextureRowManager: cannot evict — LRU empty despite exhausted capacity`);let t=this.lru.get(e);return this.lru.delete(e),t!==void 0&&(this.blockToSlot.delete(t),this.onEvict?.(t)),e}growTexture(e){let t=this.device.createTexture({size:[this.textureWidth,e],format:wn,usage:Tn});if(this.highWaterMark>0){let e=Math.min(this.capacityRows,Math.ceil(this.highWaterMark/this.slotsPerRow)),n=this.device.createCommandEncoder({label:`mid-price.texture.grow`});n.copyTextureToTexture({texture:this.texture,origin:{x:0,y:0,z:0}},{texture:t,origin:{x:0,y:0,z:0}},{width:this.textureWidth,height:e,depthOrArrayLayers:1}),this.device.queue.submit([n.finish()])}this.texture.destroy(),this.texture=t,this.capacityRows=e}},On=17,kn=class{available=[];acquire(e,t,n,r){let i=this.available.findIndex(e=>e.width===t&&e.height===n);if(i!==-1){let[e]=this.available.splice(i,1);return e}return e.createTexture({size:[t,n],format:r,usage:On})}release(e){this.available.push(e)}dispose(){for(let e of this.available)e.destroy();this.available.length=0}},An=`// Shared WGSL: Heatmap uniforms, block descriptors, data-texture binding
...
`,jn=`// Heatmap render pipeline: one instance per visible cell, 6 vertices per
...
`,Mn=`// Mid-price line shader — consumes \`mid-price-common.wgsl\`.
//
...
`,Nn=`// Shared WGSL declarations for the mid-price line overlay.
//
