...
`;function Z(e){let t=!1,n;return Q(e).then(e=>{t?e():n=e}),()=>{t=!0,n?.()}}async function Q(e){let t=await i(e),{device:n}=t,a=n.createShaderModule({code:X}),s=O(n,w,4),c=r(4),l=M(n),u=new o([new I(a,c),new J(s,l.compositeBindGroupLayout,l.compositeSampler,l.compositeUniformBuffer,a),new N(s,l),new q]);u.initAll(t);let d=Y({canvas:e,context:t,layerManager:u});return()=>{d(),u.dispose(),c.dispose(),s.destroy(),n.destroy()}}var $=a(),ee=(0,p.memo)(()=>{let e=(0,p.useRef)(null);return(0,p.useEffect)(()=>{if(e.current)return Z(e.current)},[]),(0,$.jsx)(c,{className:l.fixedContainer,children:(0,$.jsx)(`div`,{className:l.fixedContainer,children:(0,$.jsx)(`canvas`,{ref:e,className:`h-full w-full`})})})});export{ee as Charts};