...
`;function Z(e){let t=!1,n;return Q(e).then(e=>{t?e():n=e}),()=>{t=!0,n?.()}}async function Q(e){let t=await o(e),{device:n}=t,r=n.createShaderModule({code:X}),i=O(n,w,4),c=a(4),l=M(n),u=new s([new I(r,c),new J(i,l.compositeBindGroupLayout,l.compositeSampler,l.compositeUniformBuffer,r),new N(i,l),new q]);u.initAll(t);let d=Y({canvas:e,context:t,layerManager:u});return()=>{d(),u.dispose(),c.dispose(),i.destroy(),n.destroy()}}var $=t(),ee=(0,p.memo)(()=>{let e=(0,p.useRef)(null);return(0,p.useEffect)(()=>{if(e.current)return Z(e.current)},[]),(0,$.jsx)(l,{className:c.fixedContainer,children:(0,$.jsx)(`div`,{className:c.fixedContainer,children:(0,$.jsx)(`canvas`,{ref:e,className:`h-full w-full`})})})});export{ee as Charts};