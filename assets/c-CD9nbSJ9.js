import{r as e}from"./c-BlVx34DW.js";import{M as t,N as n,P as r}from"./c-C3oVsTwX.js";import{a as i,i as a,t as o}from"./c-BsSFzEEX.js";import{n as s,t as c}from"./c-Cdegn_gl.js";import{t as l}from"./c-79FAfWPB.js";import{n as u,t as d}from"./c-Br0-WPhW.js";var f=e(n(),1),p=.149,m=.149,h=.149,g=.5,_=.7,v=1e-4,y=16384,b=.5,x=.4,S=.6,C=`rgba8unorm`,w=1e3;function T(e){return Math.trunc(e/20/4)*4+1}function E(e){return Math.trunc(e/20/4)*4+1}var D={color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}};function O(e,t,n){let i=null,a=null,o=null,s=null,c=null;return{ensureOffscreenTextures(l,u,d,f,p){return!r(i)&&i.width===l&&i.height===u?r(a)||r(s)||r(c)?null:{offscreenMsaaView:a,offscreenResolveView:s,compositeBindGroup:c}:(i?.destroy(),o?.destroy(),l===0||u===0?(i=null,a=null,o=null,s=null,c=null,null):(i=e.createTexture({size:[l,u],format:t,sampleCount:n,usage:GPUTextureUsage.RENDER_ATTACHMENT}),a=i.createView(),o=e.createTexture({size:[l,u],format:t,sampleCount:1,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),s=o.createView(),c=e.createBindGroup({layout:d,entries:[{binding:0,resource:s},{binding:1,resource:f},{binding:2,resource:{buffer:p}}]}),{offscreenMsaaView:a,offscreenResolveView:s,compositeBindGroup:c}))},destroy(){i?.destroy(),o?.destroy()}}}var k=`struct CompositeUniforms {
    opacity: f32,
};
