import{a as e,t}from"./c-HFhCPKiE.js";import{t as n}from"./c-CiQY6nnt.js";import{at as r}from"./e-DhGn5ZsU.js";import{r as i,t as a}from"./c-ClMe_DGp.js";import{t as o}from"./c-CVCv-WqM.js";import{n as s,r as c,t as l}from"./c-C3goHsuv.js";import{i as u,n as d,t as f}from"./c-Dr8IWdrq.js";import{n as p,t as m}from"./c-ChaKfK4V.js";import{t as h}from"./c-7j0cS4f0.js";var g=e(n(),1),_=25e4,v=.005,y=.01,b=Math.PI/2,x=.95,S=Math.PI/4,C=.1,w=`const PI: f32 = 3.1415926535;
...
`,T=`depth24plus`,E=1,D=class{camera;msaaManager;device;format;pipeline;bindGroup;uniformBuffer;uniformView;depthTexture=null;depthTextureView=null;constructor(e,t){this.camera=e,this.msaaManager=t}init(e){this.device=e.device,this.format=e.format;let t=m(w);this.uniformView=p(t.uniforms.U),this.uniformBuffer=this.device.createBuffer({size:this.uniformView.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});let n=this.device.createShaderModule({code:w}),r=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]});this.pipeline=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[r]}),vertex:{module:n,entryPoint:`vs`,constants:{INSTANCE_COUNT:_}},fragment:{module:n,entryPoint:`fs`,targets:[{format:this.format}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{depthWriteEnabled:!0,depthCompare:`less`,format:T},multisample:{count:4}}),this.bindGroup=this.device.createBindGroup({layout:r,entries:[{binding:0,resource:{buffer:this.uniformBuffer}}]})}update(e){this.camera.tick();let t=this.camera.getViewMatrix(),n=e.canvasWidth/Math.max(E,e.canvasHeight),r=f.perspective(S,n,C,100),i=f.multiply(r,t);this.uniformView.set({time:e.time,mvp:i}),this.device.queue.writeBuffer(this.uniformBuffer,0,this.uniformView.arrayBuffer)}render(e,t,n){let i=this.msaaManager.ensureView(this.device,this.format,n.canvasWidth,n.canvasHeight);if(r(i))return;let o=this.ensureDepthView(n.canvasWidth,n.canvasHeight),s=e.beginRenderPass({colorAttachments:[{view:i,resolveTarget:t,loadOp:`clear`,clearValue:a,storeOp:`discard`}],depthStencilAttachment:{view:o,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`discard`}});s.setPipeline(this.pipeline),s.setBindGroup(0,this.bindGroup),s.draw(3,_,0,0),s.end()}dispose(){this.uniformBuffer.destroy(),this.depthTexture?.destroy()}ensureDepthView(e,t){return!r(this.depthTexture)&&!r(this.depthTextureView)&&this.depthTexture.width===e&&this.depthTexture.height===t?this.depthTextureView:(this.depthTexture?.destroy(),this.depthTexture=this.device.createTexture({size:[Math.max(E,e),Math.max(E,t)],format:T,sampleCount:4,usage:GPUTextureUsage.RENDER_ATTACHMENT}),this.depthTextureView=this.depthTexture.createView(),this.depthTextureView)}};function O(e){let t=16,n=b,r=d.fromValues(Math.sin(n)*Math.sin(0),Math.cos(n),Math.sin(n)*Math.cos(0)),i=d.fromValues(0,1,0);function a(e,t){let n=d.negate(r),a=d.normalize(d.cross(n,i));if(Math.abs(t)>0){let e=-t*v,n=f.rotation(a,e);r=d.transformMat4(r,n),i=d.normalize(d.transformMat4(i,n))}if(Math.abs(e)>0){let t=-e*v,n=f.rotation(i,t);r=d.transformMat4(r,n)}r=d.normalize(r)}function o(e){return Math.max(5,Math.min(20,e))}let s=0,c=0,l=0;function u(e,t,n){let r=n-l;l=n,r>100?(s=0,c=0):(s=e,c=t),a(e,t)}function p(e){t=o(t*e)}function m(e){t=o(t*(1+e*y))}function g(){s=0,c=0}let _=h(e,{onDrag:u,onPinch:p,onWheel:m,onReset:g});return{tick(){if(!_.hasActivePointers()){if(Math.abs(s)<.1&&Math.abs(c)<.1){s=0,c=0;return}a(s,c),s*=x,c*=x}},getViewMatrix(){let e=d.scale(r,t),n=d.fromValues(0,0,0);return f.lookAt(e,n,i)},destroy(){_.destroy()}}}function k(e){let t=O(e),n=u({init:()=>A(e,t),initErrorMessage:`Failed to initialize sun renderer`});return()=>{t.destroy(),n()}}async function A(e,t){let n=await c(e),r=o(4),i=new D(t,r),a=new s([i]);a.initAll(n);let u=l({canvas:e,context:n,layerManager:a});return{cleanup:()=>{u(),a.dispose(),r.dispose(),n.device.destroy()}}}var j=t(),M=(0,g.memo)(()=>{let e=(0,g.useRef)(null);return(0,g.useEffect)(()=>{if(e.current)return k(e.current)},[]),(0,j.jsx)(i,{className:`h-full w-full`,children:(0,j.jsx)(`canvas`,{ref:e,className:`h-full w-full [touch-action:none]`})})});export{M as Sun};