import{i as e}from"./c-Dd_uD5pT.js";import{B as t,it as n}from"./c-C8QCGV-W.js";import{i as r}from"./c-DP_47kS8.js";import{t as i}from"./c-BO8HgrYD.js";import{t as a}from"./c-BpTq7hBq.js";import{t as o}from"./c-BUVw3GsZ.js";import{t as s}from"./c-BRvpTXxQ.js";import{n as c,r as l,t as u}from"./c-C8izP36Y.js";import{n as d,t as f}from"./c-CEv-LbpK.js";import{t as p}from"./c-B0_gGLuC.js";import{t as m}from"./c-C0PiR4rC.js";import{t as h}from"./c-DTV00nEu.js";var g=e(r(),1),_=4,v=.7,y=1e-4,b=16384,x=.5,S=.4,C=.01,w=.6;function T(e){return Math.trunc(e/20/_)*_+1}function E(e){return Math.trunc(e/20/_)*_+1}var D=`rgba8unorm`,O={color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}};function k(e,t){let r,i,a;function o(){r?.destroy(),i?.destroy(),r=void 0,i=void 0,a=void 0}return{ensure(s,c){if(!n(r)&&r.width===s&&r.height===c)return a;if(o(),s===0||c===0)return;r=e.createTexture({size:[s,c],format:t.format,sampleCount:t.sampleCount,usage:GPUTextureUsage.RENDER_ATTACHMENT}),i=e.createTexture({size:[s,c],format:t.format,sampleCount:1,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING});let l=i.createView();return a={msaaView:r.createView(),resolveView:l,compositeBindGroup:e.createBindGroup({layout:t.compositeBindGroupLayout,entries:[{binding:0,resource:l},{binding:1,resource:t.compositeSampler},{binding:2,resource:{buffer:t.compositeUniformBuffer}}]})},a},dispose:o}}var A=`struct CompositeUniforms {
    opacity: f32,
};
...
`,ee=3,j=16;function M(e){let t=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`float`}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:`filtering`}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]}),n=e.createSampler({magFilter:`linear`,minFilter:`linear`}),r=e.createBuffer({size:j,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return e.queue.writeBuffer(r,0,new Float32Array([v,0,0,0])),{bindGroupLayout:t,sampler:n,uniformBuffer:r,dispose(){r.destroy()}}}var N=class{textureManager;pipeline;constructor(e,t,n){this.textureManager=t;let{device:r,format:i}=e,a=r.createShaderModule({code:A});this.pipeline=r.createRenderPipeline({layout:r.createPipelineLayout({bindGroupLayouts:[n.bindGroupLayout]}),vertex:{module:a,entryPoint:`vsComposite`},fragment:{module:a,entryPoint:`fsComposite`,targets:[{format:i,blend:O}]},primitive:{topology:`triangle-list`}})}update(){}render(e,t,r){let i=this.textureManager.ensure(r.canvasWidth,r.canvasHeight);if(n(i))return;let a=e.beginRenderPass({colorAttachments:[{view:t,loadOp:`load`,storeOp:`store`}]});a.setPipeline(this.pipeline),a.setBindGroup(0,i.compositeBindGroup),a.draw(ee,1,0,0),a.end()}dispose(){}},P=class{msaaManager;device;format;pipeline;bindGroup;constructor(e,t,n,r){this.msaaManager=n,this.device=e.device,this.format=e.format;let i=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]});this.pipeline=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[i]}),vertex:{module:t,entryPoint:`vs`},fragment:{module:t,entryPoint:`fs`,targets:[{format:this.format,blend:O}]},primitive:{topology:`triangle-list`},multisample:{count:4}}),this.bindGroup=this.device.createBindGroup({layout:i,entries:[{binding:0,resource:{buffer:r.buffer}}]})}update(){}render(e,t,r){let i=this.msaaManager.ensureView(this.device,this.format,r.canvasWidth,r.canvasHeight);if(n(i))return;let o=T(r.canvasWidth)+4,s=e.beginRenderPass({colorAttachments:[{view:i,resolveTarget:t,loadOp:`clear`,clearValue:a,storeOp:`discard`}]});s.setPipeline(this.pipeline),s.setBindGroup(0,this.bindGroup),s.draw(18,o,0,0),s.end()}dispose(){}},F=[`circle`,`square`,`rhombus`,`pentagon`,`hexagon`,`star`,`triangleUp`,`triangleDown`,`triangleLeft`,`triangleRight`],I=3,L=2*x+5/2;function R(e,t,n){return t+e()*(n-t)}function z(e,t){return t[Math.floor(e()*t.length)]}function B(e){let t=(e.r+e.g+e.b)/I;if(t>=.4)return e;let n=S/Math.max(t,C);return{r:Math.min(1,e.r*n),g:Math.min(1,e.g*n),b:Math.min(1,e.b*n)}}function V(e,t,n=Math.random){let r=R(n,20,80);return{x:R(n,-t.halfWidth+r,t.halfWidth-r),y:R(n,-t.halfHeight+r,t.halfHeight-r),halfSize:r,spawnTime:e,color:B({r:n(),g:n(),b:n()}),holdDuration:R(n,2,3),shapeType:z(n,F),fillMode:z(n,[`solid`,`outline`]),maxOpacity:R(n,w,1)}}function H(e){return 2*x+e.holdDuration}function U(e,t,n){let r=e/n*(t/n);return Math.min(Math.max(1,Math.round(r*y)),b)}function W(e,t,n,r=Math.random){return Array.from({length:e},(i,a)=>V(t-L/e*a,n,r))}function G(e,t,n,r,i=Math.random){return t<e.length?e.slice(0,t):[...e,...W(t-e.length,n,r,i)]}function te(e,t,n,r=Math.random){return e.map(e=>t-e.spawnTime>H(e)?V(t,n,r):e)}var K=`struct Uniforms {
    mvp: mat4x4<f32>,
    viewport: vec2<f32>,
    time: f32,
    sinCount: u32,
...
`,J=48/Float32Array.BYTES_PER_ELEMENT,Y=4,X=8,Z={solid:0,outline:1};function Q(e){return new Float32Array(e*J)}function ne(e,t){return t.forEach((t,n)=>{let r=n*J;e[r]=t.x,e[r+1]=t.y,e[r+2]=t.halfSize,e[r+3]=t.spawnTime,e[r+Y]=t.color.r,e[r+Y+1]=t.color.g,e[r+Y+2]=t.color.b,e[r+Y+3]=t.holdDuration,e[r+X]=F.indexOf(t.shapeType),e[r+X+1]=Z[t.fillMode],e[r+X+2]=t.maxOpacity,e[r+X+3]=0}),t.length*48}var re=K+q,ie={color:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}},ae=class{device;pipeline;bindGroup;storageBuffer;shapeData=Q(b);shapes=[];constructor(e,t){this.device=e.device;let n=this.device.createShaderModule({code:re}),r=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`read-only-storage`}}]});this.storageBuffer=this.device.createBuffer({size:b*48,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.pipeline=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[r]}),vertex:{module:n,entryPoint:`vsShapes`,constants:{FADE_DURATION:x}},fragment:{module:n,entryPoint:`fsShapes`,targets:[{format:e.format,blend:ie}]},primitive:{topology:`triangle-list`}}),this.bindGroup=this.device.createBindGroup({layout:r,entries:[{binding:0,resource:{buffer:t.buffer}},{binding:1,resource:{buffer:this.storageBuffer}}]})}update(e){let{time:t,canvasWidth:n,canvasHeight:r,devicePixelRatio:i}=e,a={halfWidth:n/2,halfHeight:r/2},o=U(n,r,i),s=this.shapes.length===0?W(o,t,a):G(this.shapes,o,t,a);this.shapes=te(s,t,a);let c=ne(this.shapeData,this.shapes);this.device.queue.writeBuffer(this.storageBuffer,0,this.shapeData.buffer,0,c)}render(e,t){if(this.shapes.length===0)return;let n=e.beginRenderPass({colorAttachments:[{view:t,loadOp:`load`,storeOp:`store`}]});n.setPipeline(this.pipeline),n.setBindGroup(0,this.bindGroup),n.draw(6,this.shapes.length,0,0),n.end()}dispose(){this.storageBuffer.destroy()}},oe=class{textureManager;pipeline;bindGroup;constructor(e,t,n,r){this.textureManager=t;let{device:i}=e,a=i.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]});this.pipeline=i.createRenderPipeline({layout:i.createPipelineLayout({bindGroupLayouts:[a]}),vertex:{module:n,entryPoint:`vsSinY`},fragment:{module:n,entryPoint:`fsSinY`,targets:[{format:D,blend:O}]},primitive:{topology:`triangle-list`},multisample:{count:4}}),this.bindGroup=i.createBindGroup({layout:a,entries:[{binding:0,resource:{buffer:r.buffer}}]})}update(){}render(e,t,r){let i=this.textureManager.ensure(r.canvasWidth,r.canvasHeight);if(n(i))return;let a=e.beginRenderPass({colorAttachments:[{view:i.msaaView,resolveTarget:i.resolveView,loadOp:`clear`,clearValue:{r:0,g:0,b:0,a:0},storeOp:`discard`}]});a.setPipeline(this.pipeline),a.setBindGroup(0,this.bindGroup),a.draw(18,E(r.canvasHeight),0,0),a.end()}dispose(){}},se=`const PI: f32 = 3.14159265358979323846;
const HALF: f32 = 0.5;
...
`;function ce(e,t){let n=f(t),r=d(n.uniforms.U),i=e.createBuffer({size:r.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return{buffer:i,writeFromFrameState(t){let n=t.canvasWidth/2,a=t.canvasHeight/2,o=T(t.canvasWidth);r.set({mvp:h.ortho(-n,n,-a,a,-1,1),viewport:[t.canvasWidth,t.canvasHeight],time:t.time,sinCount:o,sinPenMin:2,sinPenMax:20,borderMargin:20,borderOffset:o,sinYCount:E(t.canvasHeight)}),e.queue.writeBuffer(i,0,r.arrayBuffer)},dispose(){i.destroy()}}}var le=K+se;function ue(e){return p({init:()=>de(e),initErrorMessage:`Failed to initialize charts renderer`})}async function de(e){let t=await l(e),{device:n}=t,r=n.createShaderModule({code:le}),i=ce(n,K),a=o(4),s=M(n),d=k(n,{format:D,sampleCount:4,compositeBindGroupLayout:s.bindGroupLayout,compositeSampler:s.sampler,compositeUniformBuffer:s.uniformBuffer}),f=new c([m(i.writeFromFrameState),new P(t,r,a,i),new oe(t,d,r,i),new N(t,d,s),new ae(t,i)]),p=u({canvas:e,context:t,layerManager:f});return{cleanup:()=>{p(),f.dispose(),d.dispose(),s.dispose(),i.dispose(),a.dispose(),n.destroy()}}}var $=t(),fe=(0,g.memo)(()=>{let e=s(ue);return(0,$.jsx)(i,{className:`h-full w-full`,children:(0,$.jsx)(`canvas`,{ref:e,className:`h-full w-full`})})});export{fe as Charts};