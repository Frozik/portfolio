...
`;function q(e,t){let n=d(f(t).uniforms.U),r=e.createBuffer({size:n.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return{buffer:r,writeFromFrameState(e,t){let i=t.canvasWidth*m,a=t.canvasHeight*m,o=u.ortho(-i,i,-a,a,-1,1),s=x(t.canvasWidth),c=S(t.canvasHeight);n.set({mvp:o,viewport:[t.canvasWidth,t.canvasHeight],time:t.time,sinCount:s,sinPenMin:2,sinPenMax:20,borderMargin:20,borderOffset:s,sinYCount:c}),e.queue.writeBuffer(r,0,n.arrayBuffer)},dispose(){r.destroy()}}}var J=B+K;function Y(e){let t=!1,n;return X(e).then(e=>{t?e():n=e},e=>{console.error(`Failed to initialize charts renderer`,e)}),()=>{t=!0,n?.()}}async function X(e){let t=await l(e),{device:n}=t,r=n.createShaderModule({code:J}),i=T(n,C,4),a=o(4),u=k(n),d=q(n,B),f=new s([new G(d),new j(r,a,d),new W(i,u.compositeBindGroupLayout,u.compositeSampler,u.compositeUniformBuffer,r,d),new A(i,u),new U(d)]);f.initAll(t);let p=c({canvas:e,context:t,layerManager:f});return()=>{p(),f.dispose(),d.dispose(),a.dispose(),i.destroy(),n.destroy()}}var Z=t(),Q=(0,p.memo)(()=>{let e=(0,p.useRef)(null);return(0,p.useEffect)(()=>{if(e.current)return Y(e.current)},[]),(0,Z.jsx)(i,{className:`h-full w-full`,children:(0,Z.jsx)(`canvas`,{ref:e,className:`h-full w-full`})})});export{Q as Charts};