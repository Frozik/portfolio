import{a as e,t}from"./c-BuTfruC8.js";import{t as n}from"./c-oF12xhiC.js";import{t as r}from"./c-DpbFSzKL.js";import{n as i,t as a}from"./c-DlylAQCu2.js";import{a as o,i as s,n as c,o as l,t as u}from"./c-DHn3VVAF.js";import{n as d,t as f}from"./c-D25L1m3a.js";var p=e(r(),1),m=25e4,h={r:.02745,g:.03529,b:.04706,a:1},g=.005,_=.01,v=Math.PI/2,y=.95,b=Math.PI/4,x=.1,S=`const PI: f32 = 3.1415926535;
...
`,C=`depth24plus`,w=1,T=class{device;format;pipeline;bindGroup;uniformBuffer;uniformView;depthTexture=null;constructor(e,t){this.camera=e,this.msaaManager=t}init(e){this.device=e.device,this.format=e.format,this.uniformView=d(f(S).uniforms.U),this.uniformBuffer=this.device.createBuffer({size:this.uniformView.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});let t=this.device.createShaderModule({code:S}),n=this.device.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]});this.pipeline=this.device.createRenderPipeline({layout:this.device.createPipelineLayout({bindGroupLayouts:[n]}),vertex:{module:t,entryPoint:`vs`,constants:{INSTANCE_COUNT:m}},fragment:{module:t,entryPoint:`fs`,targets:[{format:this.format}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{depthWriteEnabled:!0,depthCompare:`less`,format:C},multisample:{count:4}}),this.bindGroup=this.device.createBindGroup({layout:n,entries:[{binding:0,resource:{buffer:this.uniformBuffer}}]})}update(e){this.camera.tick();let t=this.camera.getViewMatrix(),n=e.canvasWidth/Math.max(w,e.canvasHeight),r=u.perspective(b,n,x,100),i=u.multiply(r,t);this.uniformView.set({time:e.time,mvp:i}),this.device.queue.writeBuffer(this.uniformBuffer,0,this.uniformView.arrayBuffer)}render(e,t,r){let i=this.msaaManager.ensureView(this.device,this.format,r.canvasWidth,r.canvasHeight);if(n(i))return;let a=this.ensureDepthTexture(r.canvasWidth,r.canvasHeight),o=e.beginRenderPass({colorAttachments:[{view:i,resolveTarget:t,loadOp:`clear`,clearValue:h,storeOp:`discard`}],depthStencilAttachment:{view:a.createView(),depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`discard`}});o.setPipeline(this.pipeline),o.setBindGroup(0,this.bindGroup),o.draw(3,m,0,0),o.end()}dispose(){this.uniformBuffer.destroy(),this.depthTexture?.destroy()}ensureDepthTexture(e,t){return!n(this.depthTexture)&&this.depthTexture.width===e&&this.depthTexture.height===t?this.depthTexture:(this.depthTexture?.destroy(),this.depthTexture=this.device.createTexture({size:[Math.max(w,e),Math.max(w,t)],format:C,sampleCount:4,usage:GPUTextureUsage.RENDER_ATTACHMENT}),this.depthTexture)}};function E(e){let t=16,n=v,r=c.fromValues(Math.sin(n)*Math.sin(0),Math.cos(n),Math.sin(n)*Math.cos(0)),i=c.fromValues(0,1,0);function a(e,t){let n=c.negate(r),a=c.normalize(c.cross(n,i));if(Math.abs(t)>0){let e=-t*g,n=u.rotation(a,e);r=c.transformMat4(r,n),i=c.normalize(c.transformMat4(i,n))}if(Math.abs(e)>0){let t=-e*g,n=u.rotation(i,t);r=c.transformMat4(r,n)}r=c.normalize(r)}function o(e){return Math.max(5,Math.min(20,e))}let s=0,l=0,d=new Map,f=0;function p(){let e=[...d.values()],t=e[0].clientX-e[1].clientX,n=e[0].clientY-e[1].clientY;return Math.sqrt(t*t+n*n)}function m(e){d.set(e.pointerId,{clientX:e.clientX,clientY:e.clientY}),d.size===2&&(f=p())}function h(e){let n=d.get(e.pointerId);if(n===void 0)return;if(d.set(e.pointerId,{clientX:e.clientX,clientY:e.clientY}),d.size===2){let e=p(),n=f/e;t=o(t*n),f=e;return}if(d.size!==1)return;let r=e.clientX-n.clientX,i=e.clientY-n.clientY;s=r,l=i,a(r,i)}function b(e){d.delete(e.pointerId)}function x(e){d.delete(e.pointerId)}function S(e){e.preventDefault(),t=o(t*(1+e.deltaY*_))}return e.addEventListener(`pointerdown`,m),window.addEventListener(`pointermove`,h),window.addEventListener(`pointerup`,b),window.addEventListener(`pointercancel`,x),e.addEventListener(`wheel`,S,{passive:!1}),{tick(){if(!(d.size>0)){if(Math.abs(s)<.1&&Math.abs(l)<.1){s=0,l=0;return}a(s,l),s*=y,l*=y}},getViewMatrix(){let e=c.scale(r,t),n=c.fromValues(0,0,0);return u.lookAt(e,n,i)},destroy(){e.removeEventListener(`pointerdown`,m),window.removeEventListener(`pointermove`,h),window.removeEventListener(`pointerup`,b),window.removeEventListener(`pointercancel`,x),e.removeEventListener(`wheel`,S)}}}function D(e){let t=!1,n,r=E(e);return O(e,r).then(e=>{t?e():n=e}),()=>{t=!0,r.destroy(),n?.()}}async function O(e,t){let n=await l(e),r=a(4),i=new o([new T(t,r)]);i.initAll(n);let c=s({canvas:e,context:n,layerManager:i});return()=>{c(),i.dispose(),r.dispose(),n.device.destroy()}}var k=t(),A=(0,p.memo)(()=>{let e=(0,p.useRef)(null);return(0,p.useEffect)(()=>{if(e.current)return D(e.current)},[]),(0,k.jsx)(i,{className:`h-full w-full`,children:(0,k.jsx)(`canvas`,{ref:e,className:`h-full w-full [touch-action:none]`})})});export{A as Sun};