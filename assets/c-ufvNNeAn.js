...
`;function ce(e,t){let n=p(t),r=f(n.uniforms.U),i=e.createBuffer({size:r.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return{buffer:i,writeFromFrameState(t){let n=t.canvasWidth/2,a=t.canvasHeight/2,o=T(t.canvasWidth);r.set({mvp:h.ortho(-n,n,-a,a,-1,1),viewport:[t.canvasWidth,t.canvasHeight],time:t.time,sinCount:o,sinPenMin:2,sinPenMax:20,borderMargin:20,borderOffset:o,sinYCount:E(t.canvasHeight)}),e.queue.writeBuffer(i,0,r.arrayBuffer)},dispose(){i.destroy()}}}var le=K+se;function ue(e){return d({init:()=>de(e),initErrorMessage:`Failed to initialize charts renderer`})}async function de(e){let t=await c(e),{device:n}=t,r=n.createShaderModule({code:le}),i=ce(n,K),a=o(4),s=M(n),d=k(n,{format:D,sampleCount:4,compositeBindGroupLayout:s.bindGroupLayout,compositeSampler:s.sampler,compositeUniformBuffer:s.uniformBuffer}),f=new u([m(i.writeFromFrameState),new P(t,r,a,i),new oe(t,d,r,i),new N(t,d,s),new ae(t,i)]),p=l({canvas:e,context:t,layerManager:f});return{cleanup:()=>{p(),f.dispose(),d.dispose(),s.dispose(),i.dispose(),a.dispose(),n.destroy()}}}var $=t(),fe=(0,g.memo)(()=>{let e=s(ue);return(0,$.jsx)(i,{className:`h-full w-full`,children:(0,$.jsx)(`canvas`,{ref:e,className:`h-full w-full`})})});export{fe as Charts};