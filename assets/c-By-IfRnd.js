...
`,Vt=W+It,Ht=W+Rt,Ut=W+Lt,Wt=W+zt,Gt=W+Bt,G=`depth24plus`,Kt=`rg16float`,qt=2,Jt=1,Yt=0,K=1,q=2,J={color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}};function Xt(e,t){let n={binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},r=[{binding:1,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,texture:{sampleType:`depth`}},{binding:2,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,sampler:{type:`non-filtering`}}],i=[{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`unfilterable-float`}},{binding:4,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`depth`}}],a=e.createBindGroupLayout({entries:[n]}),o=e.createBindGroupLayout({entries:[n,...r]}),s=e.createBindGroupLayout({entries:[n,...r,...i]}),c=e.createPipelineLayout({bindGroupLayouts:[a]}),l=e.createPipelineLayout({bindGroupLayouts:[o]}),u=e.createPipelineLayout({bindGroupLayouts:[s]}),d=e.createShaderModule({code:Ht}),f=e.createShaderModule({code:Gt}),p=e.createShaderModule({code:Ut});return{uniformBindGroupLayout:a,depthBindGroupLayout:o,markerBindGroupLayout:s,depthPrePass:Zt(e,c),solutionFace:Qt(e,t,c),hiddenLine:Y(e,t,l,d,{renderMode:K,depthTest:!0}),visibleLine:Y(e,t,l,d,{renderMode:q,depthTest:!0}),previewLine:Y(e,t,l,d,{renderMode:Yt,depthTest:!1}),hiddenMarker:X(e,t,u,f,{renderMode:K,lineOcclusion:!0}),visibleMarker:X(e,t,u,f,{renderMode:q,lineOcclusion:!0}),previewMarker:X(e,t,u,f,{renderMode:Yt,lineOcclusion:!1}),hiddenLineId:$t(e,l,p,K),visibleLineId:$t(e,l,p,q)}}function Y(e,t,n,r,{renderMode:i,depthTest:a}){return e.createRenderPipeline({layout:n,vertex:{module:r,entryPoint:`vs`,buffers:[{arrayStride:96,stepMode:`instance`,attributes:[...vt]}]},fragment:{module:r,entryPoint:`fs`,constants:{renderMode:i},targets:[{format:t,blend:J}]},primitive:{topology:`triangle-list`},depthStencil:a?{depthWriteEnabled:!0,depthCompare:`less-equal`,format:G}:{depthWriteEnabled:!1,depthCompare:`always`,format:G},multisample:{count:4}})}function Zt(e,t){let n=e.createShaderModule({code:Vt});return e.createRenderPipeline({layout:t,vertex:{module:n,entryPoint:`vs`,buffers:[{arrayStride:xt,attributes:[...St]}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{depthWriteEnabled:!0,depthCompare:`less`,format:G,depthBias:qt,depthBiasSlopeScale:Jt}})}function Qt(e,t,n){let r=e.createShaderModule({code:Wt});return e.createRenderPipeline({layout:n,vertex:{module:r,entryPoint:`vs`,buffers:[{arrayStride:Ct,attributes:[...wt]}]},fragment:{module:r,entryPoint:`fs`,targets:[{format:t,blend:J}]},primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{depthWriteEnabled:!1,depthCompare:`always`,format:G},multisample:{count:4}})}function X(e,t,n,r,{renderMode:i,lineOcclusion:a}){return e.createRenderPipeline({layout:n,vertex:{module:r,entryPoint:`vs`,buffers:[{arrayStride:96,stepMode:`instance`,attributes:[...bt]}]},fragment:{module:r,entryPoint:`fs`,constants:{renderMode:i,enableLineOcclusion:+!!a},targets:[{format:t,blend:J}]},primitive:{topology:`triangle-list`},depthStencil:{depthWriteEnabled:!1,depthCompare:`always`,format:G},multisample:{count:4}})}function $t(e,t,n,r){return e.createRenderPipeline({layout:t,vertex:{module:n,entryPoint:`vs`,buffers:[{arrayStride:96,stepMode:`instance`,attributes:[...yt]}]},fragment:{module:n,entryPoint:`fs`,constants:{renderMode:r},targets:[{format:Kt}]},primitive:{topology:`triangle-list`},depthStencil:{depthWriteEnabled:!0,depthCompare:`less`,format:G}})}var en=1,Z=GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING,tn=class{depth=N(4,G);faceDepth=N(en,G,Z);lineEndpoint=N(en,Kt,Z);lineDepth=N(en,G,Z);ensure(e,t,n){return{depth:this.depth.ensureView(e,t,n),faceDepth:this.faceDepth.ensureView(e,t,n),lineEndpoint:this.lineEndpoint.ensureView(e,t,n),lineDepth:this.lineDepth.ensureView(e,t,n)}}dispose(){this.depth.dispose(),this.faceDepth.dispose(),this.lineEndpoint.dispose(),this.lineDepth.dispose()}},nn=ce(W).uniforms.uniforms,rn=class{device;buffer;view=se(nn);constructor(e){this.device=e,this.buffer=e.createBuffer({size:this.view.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}write(e){this.view.set(e),this.device.queue.writeBuffer(this.buffer,0,this.view.arrayBuffer)}dispose(){this.buffer.destroy()}},an=6,on={r:-1,g:-1,b:0,a:0},sn=GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST,cn=class{camera;msaaManager;topology;fpsController;sceneCenter;projection;device;format;pipelines;uniforms;depthSampler;uniformBindGroup;bindGroups;boundViews;targets=new tn;faceVertexBuffer;faceVertexCount=0;solutionFaceBuffer;solutionFaceVertexCount=0;styledLineBuffer;styledLineCount=0;markerBuffer;markerCount=0;previewBuffers;dirty=!0;projectionScratch=M.create();mvpScratch=M.create();lastMvpMatrix=new Float32Array(16);lastViewport={canvasWidth:0,canvasHeight:0,devicePixelRatio:1};previewLine;hasStartMarker=!1;hasSnapTarget=!1;backgroundClearColor=pt();constructor(e,t,n,r,i,a=`perspective`){this.camera=e,this.msaaManager=t,this.topology=n,this.fpsController=r,this.sceneCenter=i,this.projection=a}init(e){this.device=e.device,this.format=e.format;let t=We(this.topology);this.faceVertexCount=t.faceVertexCount,this.faceVertexBuffer=this.device.createBuffer({size:t.facePositions.byteLength,usage:sn}),this.device.queue.writeBuffer(this.faceVertexBuffer,0,t.facePositions),this.solutionFaceBuffer=new H(this.device,Ct),this.styledLineBuffer=new H(this.device,96),this.markerBuffer=new H(this.device,96),this.previewBuffers=new Nt(this.device),this.uniforms=new rn(this.device),this.pipelines=Xt(this.device,this.format),this.depthSampler=this.device.createSampler({minFilter:`nearest`,magFilter:`nearest`}),this.uniformBindGroup=this.device.createBindGroup({layout:this.pipelines.uniformBindGroupLayout,entries:[{binding:0,resource:{buffer:this.uniforms.buffer}}]})}update(e){let t=this.camera.tick();t&&this.fpsController.raise(60);let n=this.camera.getViewMatrix(),r=this.camera.getDistance(),i=ge(he(this.projection,xe(e.canvasWidth,e.canvasHeight),r,this.projectionScratch),n,this.mvpScratch),a=e.canvasWidth!==this.lastViewport.canvasWidth||e.canvasHeight!==this.lastViewport.canvasHeight||e.devicePixelRatio!==this.lastViewport.devicePixelRatio;(t||a||!ln(this.lastMvpMatrix,i))&&(this.dirty=!0),this.dirty&&(this.lastMvpMatrix.set(i),this.lastViewport={canvasWidth:e.canvasWidth,canvasHeight:e.canvasHeight,devicePixelRatio:e.devicePixelRatio},this.uniforms.write({mvp:i,viewport:[e.canvasWidth,e.canvasHeight],dpr:e.devicePixelRatio,cameraDistance:r,cameraForward:[-n[2],-n[6],-n[10]],cameraTarget:this.sceneCenter,depthFadeRate:fe,depthFadeMin:Fe}))}consumeDirty(){let e=this.dirty;return this.dirty=!1,e}render(e,t,n){let r=this.msaaManager.ensureView(this.device,this.format,n.canvasWidth,n.canvasHeight);if(o(r))return;let i=this.targets.ensure(this.device,n.canvasWidth,n.canvasHeight);this.bindTargets(i),this.encodeDepthPrePass(e,i);let a=this.styledLineCount>0&&this.markerCount>0;a&&this.encodeLineIdPass(e,i,this.pipelines.hiddenLineId),this.encodeHiddenPass(e,r,i.depth),a&&this.encodeLineIdPass(e,i,this.pipelines.visibleLineId),this.encodeVisiblePass(e,r,t,i.depth)}bindTargets(e){this.boundViews===e||Ft(this.boundViews,e)||(this.boundViews=e,this.bindGroups=Pt(this.device,this.pipelines,this.uniforms.buffer,this.depthSampler,e))}encodeDepthPrePass(e,t){let n=e.beginRenderPass({colorAttachments:[],depthStencilAttachment:{view:t.faceDepth,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});n.setPipeline(this.pipelines.depthPrePass),n.setBindGroup(0,this.uniformBindGroup),n.setVertexBuffer(0,this.faceVertexBuffer),n.draw(this.faceVertexCount),n.end()}encodeLineIdPass(e,t,n){let r=e.beginRenderPass({colorAttachments:[{view:t.lineEndpoint,clearValue:on,loadOp:`clear`,storeOp:`store`}],depthStencilAttachment:{view:t.lineDepth,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`store`}});this.drawLines(r,n,this.styledLineBuffer.handle,this.styledLineCount),r.end()}encodeHiddenPass(e,t,n){let r=e.beginRenderPass({colorAttachments:[{view:t,loadOp:`clear`,clearValue:this.backgroundClearColor,storeOp:`store`}],depthStencilAttachment:{view:n,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`discard`}});this.solutionFaceVertexCount>0&&(r.setPipeline(this.pipelines.solutionFace),r.setBindGroup(0,this.uniformBindGroup),r.setVertexBuffer(0,this.solutionFaceBuffer.handle),r.draw(this.solutionFaceVertexCount)),this.drawLines(r,this.pipelines.hiddenLine,this.styledLineBuffer.handle,this.styledLineCount),this.drawMarkers(r,this.pipelines.hiddenMarker,this.markerBuffer.handle,this.markerCount),r.end()}encodeVisiblePass(e,t,n,r){let i=e.beginRenderPass({colorAttachments:[{view:t,resolveTarget:n,loadOp:`load`,storeOp:`discard`}],depthStencilAttachment:{view:r,depthClearValue:1,depthLoadOp:`clear`,depthStoreOp:`discard`}});this.drawLines(i,this.pipelines.visibleLine,this.styledLineBuffer.handle,this.styledLineCount),this.drawMarkers(i,this.pipelines.visibleMarker,this.markerBuffer.handle,this.markerCount),o(this.previewLine)||this.drawLines(i,this.pipelines.previewLine,this.previewBuffers.line,1),this.hasStartMarker&&this.drawMarkers(i,this.pipelines.previewMarker,this.previewBuffers.startMarker,1),this.hasSnapTarget&&this.drawMarkers(i,this.pipelines.previewMarker,this.previewBuffers.snapMarker,1),i.end()}drawLines(e,t,n,r){r===0||o(this.bindGroups)||(e.setPipeline(t),e.setBindGroup(0,this.bindGroups.line),e.setVertexBuffer(0,n),e.draw(6,r))}drawMarkers(e,t,n,r){r===0||o(this.bindGroups)||(e.setPipeline(t),e.setBindGroup(0,this.bindGroups.marker),e.setVertexBuffer(0,n),e.draw(an,r))}getPreviewLine(){return this.previewLine}setDragPreview(e){if(this.dirty=!0,o(e)){this.previewLine=void 0,this.hasStartMarker=!1,this.hasSnapTarget=!1;return}let t=ht(e,(e,t,n)=>mt(this.lastMvpMatrix,this.lastViewport,e,t,n));this.previewLine=t,this.previewBuffers.writeLine(t),this.hasStartMarker=e.kind===`vertex`,e.kind===`vertex`&&this.previewBuffers.writeStartMarker(e.startPosition),this.hasSnapTarget=!o(e.snapTargetPosition),o(e.snapTargetPosition)||this.previewBuffers.writeSnapMarker(e.snapTargetPosition)}applySceneState(e){let t=ut(e);this.dirty=!0,this.applyMarkers(t.markers),this.applySegments(t.segments),this.applySolutionFace(t.solutionFace)}applySolutionFace(e){this.solutionFaceVertexCount=e?.vertexCount??0,!o(e)&&e.vertexCount>0&&this.solutionFaceBuffer.write(e.vertices)}applyMarkers(e){this.markerCount=e.length,e.length>0&&this.markerBuffer.write(jt(e))}applySegments(e){this.styledLineCount=e.length,e.length>0&&this.styledLineBuffer.write(Dt(e))}dispose(){this.uniforms.dispose(),this.faceVertexBuffer.destroy(),this.solutionFaceBuffer.dispose(),this.styledLineBuffer.dispose(),this.markerBuffer.dispose(),this.previewBuffers.dispose(),this.targets.dispose()}};function ln(e,t){for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0}var un=[`vertex`,`line`];function dn(e,t,n,r,i,a,o,s,c=un){let l=n*i,u=r*i,d=e*i,f=t*i,p=30*i,m=20*i,h=p**2,g=m**2,_=[];return c.includes(`vertex`)&&fn(a,s,d,f,l,u,p,h,_),c.includes(`line`)&&pn(a,o,d,f,l,u,m,g,_),hn(_)}function fn(e,t,n,r,i,a,o,s,c){for(let l=0;l<t.length;l++){let u=ze(e,t[l],i,a);if(u.behindCamera)continue;let d=u.screenX-n,f=u.screenY-r,p=d*d+f*f;p>=s||c.push({hit:{type:`vertex`,position:t[l]},normalizedDistance:Math.sqrt(p)/o,depth:u.depth,typeBonus:Se})}}function pn(e,t,n,r,i,a,o,s,c){for(let l=0;l<t.length;l++){let u=t[l],[d,f]=u.kind===`edge`||u.kind===`segment`?[u.pointA,u.pointB]:Me(u.pointA,u.pointB),p=Le(e,d,f,i,a);if(p.start.behindCamera||p.end.behindCamera)continue;let{distanceSquared:m,parameter:h}=mn(n,r,p.start.screenX,p.start.screenY,p.end.screenX,p.end.screenY);if(m>=s)continue;let g=p.start.depth*p.end.depth/((1-h)*p.end.depth+h*p.start.depth),_=u.kind===`line`?0:be;c.push({hit:{type:`line`,lineId:u.lineId},normalizedDistance:Math.sqrt(m)/o,depth:g,typeBonus:_})}}function mn(e,t,n,r,i,a){let o=i-n,s=a-r,c=o*o+s*s;if(c===0){let i=e-n,a=t-r;return{distanceSquared:i*i+a*a,parameter:0}}let l=Math.max(0,Math.min(1,((e-n)*o+(t-r)*s)/c)),u=n+l*o,d=r+l*s,f=e-u,p=t-d;return{distanceSquared:f*f+p*p,parameter:l}}function hn(e){if(e.length===0)return;let t=1/0,n=-1/0;for(let r of e)r.depth<t&&(t=r.depth),r.depth>n&&(n=r.depth);let r=n-t,i=-1/0,a;for(let n of e){let e=1-n.normalizedDistance,o=r>0?1-(n.depth-t)/r:1,s=ye*e+Pe*o+n.typeBonus;s>i&&(i=s,a=n.hit)}return a}var gn=[`vertex`];function _n(e){let{canvas:t,getMvpMatrix:n,getTopology:r}=e;function i(e,i,a){let o=r();return dn(e,i,t.clientWidth,t.clientHeight,Math.max(1,window.devicePixelRatio),n(),o.lines,o.vertices.map(e=>e.position),a)}function a(e,t){let n=i(e,t);return n?.type===`line`?{type:`line`,lineId:n.lineId}:I}function o(e,t){let n=i(e,t);if(n===void 0)return;if(n.type===`vertex`)return{kind:`vertex`,position:n.position};let a=r().lines.find(e=>e.lineId===n.lineId);if(a===void 0)return;let o=ue.sub(a.pointB,a.pointA);return{kind:`line`,lineId:n.lineId,direction:[o[0],o[1],o[2]],planeAnchor:a.pointA}}function s(e,t){let n=i(e,t,gn);return n?.type===`vertex`?n.position:void 0}return{hitTestSelection:a,hitTestDragStart:o,hitTestSnapVertex:s}}var vn=100;function yn(){let e=[],t=[];return{push(n){e.push(n),t.length=0,e.length>vn&&e.shift()},undo(n){let r=e.pop();if(r!==void 0)return t.push(n),r},redo(n){let r=t.pop();if(r!==void 0)return e.push(n),r},canUndo(){return e.length>0},canRedo(){return t.length>0}}}function bn(e){let{puzzle:t,figureTopology:n}=e,r=new Ue,i=new je,a=yn(),o=_({canUndo:!1,canRedo:!1}),s,c=Oe(n,t.input,r),l=I,u;function d(){let e=Ie(t.expected,c),r=Ae(n,c.lines,c.vertices,l,u,e,i);s?.applySceneState(r)}let f=v(()=>{o.canUndo=a.canUndo(),o.canRedo=a.canRedo()});function p(e){a.push(c),c=e,d(),f()}function m(){return c}function h(){return l.type!==`none`}function g(e){return l.type===`line`&&l.lineId===e}function y(e){l=e,d()}function b(e){u=e,d()}function x(){switch(l.type){case`line`:{let e=l.lineId,t=c.lines.find(t=>t.lineId===e);return t===void 0?void 0:ue.sub(t.pointB,t.pointA)}case`none`:return;default:C(l)}}function S(e,t){p(Be(c,e,t,n,r)),y(I)}function w(e){let t=x();if(t!==void 0){let i=[e[0]+t[0],e[1]+t[1],e[2]+t[2]];p(Be(c,e,i,n,r))}y(I)}function T(e){let t=c.lines.find(t=>t.lineId===e);if(t!==void 0)switch(l=I,t.kind){case`edge`:case`segment`:p(Re(c,e,n,r));break;case`edge-extended`:case`segment-extended`:p(Ne(c,e,n,r));break;case`line`:p(Ve(c,e,n,r));break;default:C(t.kind)}}function E(e){e!==void 0&&(c=e,d(),y(I),f())}function D(){E(a.undo(c))}function O(){E(a.redo(c))}function k(e){s=e,d()}return{history:o,getTopology:m,hasSelection:h,isLineSelected:g,setSelection:y,setPreviewLine:b,connectVertices:S,createParallelLineAtVertex:w,toggleLineExtension:T,undo:D,redo:O,attachRenderer:k}}function xn(e){let{canvas:t,puzzle:n,getInteractionMode:r,onFpsUpdate:i}=e,a,{topology:o}=Te(n),s=Xe(t,n.camera,r),c=new O(10),l=n.camera?.projection??`perspective`,u=bn({puzzle:n,figureTopology:o}),d=_n({canvas:t,getTopology:u.getTopology,getMvpMatrix:()=>ge(he(l,xe(t.clientWidth,t.clientHeight),s.getDistance()),s.getViewMatrix())});function f(e,t){u.setSelection(d.hitTestSelection(e,t))}function p(){c.raise(60)}t.addEventListener(`pointerdown`,p),t.addEventListener(`pointermove`,p),t.addEventListener(`wheel`,p);let m=Ze(t,f),h=Qe(t,{performInitialHitTest:d.hitTestDragStart,performSnapHitTest:d.hitTestSnapVertex,hasActiveSelection:u.hasSelection,isLineSelected:u.isLineSelected,onDragUpdate:e=>{a?.setDragPreview(e),u.setPreviewLine(a?.getPreviewLine())},onLineTap:e=>u.setSelection({type:`line`,lineId:e}),onLineDoubleTap:u.toggleLineExtension,onVertexTap:u.createParallelLineAtVertex,onDragComplete:u.connectVertices,onSecondPointer:(e,t,n)=>{s.registerExternalPointer(e,t,n)}}),g=le({init:()=>Sn({canvas:t,camera:s,figureTopology:o,puzzle:n,fpsController:c,onFpsUpdate:i}),onReady:({sceneLayer:e})=>{a=e,u.attachRenderer(e)},initErrorMessage:`Failed to initialize stereometry renderer`});return{history:u.history,destroy:()=>{a=void 0,s.destroy(),c.dispose(),t.removeEventListener(`pointerdown`,p),t.removeEventListener(`pointermove`,p),t.removeEventListener(`wheel`,p),m(),h(),g()},undo:u.undo,redo:u.redo}}async function Sn({canvas:e,camera:t,figureTopology:n,puzzle:r,fpsController:i,onFpsUpdate:a}){let o=await ae(e),s=E(4),c=new cn(t,s,n,i,r.camera?.center??[0,0,0],r.camera?.projection??`perspective`),l=new ie([c]);l.initAll(o);let u=oe({canvas:e,context:o,layerManager:l,fpsController:i,onFpsUpdate:a,shouldRender:()=>c.consumeDirty(),onResize:()=>i.raise(60)});return{cleanup:()=>{u(),l.dispose(),s.dispose(),o.device.destroy()},sceneLayer:c}}var Cn=class{fps=0;interactionMode=`rotate`;session=void 0;constructor(){g(this,{session:y},{autoBind:!0})}get canUndo(){return this.session?.history.canUndo??!1}get canRedo(){return this.session?.history.canRedo??!1}attach(e){this.session=e,this.fps=0}detach(){this.session=void 0}setFps(e){this.fps=e}setInteractionMode(e){this.interactionMode=e}undo(){this.session?.undo()}redo(){this.session?.redo()}dispose(){this.detach()}},wn=`stereometry`;function Tn(){let e=S(),t=e.getOrCreateFeatureStore(wn,()=>new Cn);return T(e,wn),t}var Q=t(),En=(0,B.memo)(()=>{let[e,t]=(0,B.useState)(!1);return(0,Q.jsxs)(te,{open:e,onOpenChange:t,children:[(0,Q.jsx)(x,{title:R.toolbar.help,delayDuration:300,children:(0,Q.jsx)(re,{asChild:!0,children:(0,Q.jsx)(`button`,{type:`button`,"aria-label":R.toolbar.help,className:r(`flex size-10 items-center justify-center rounded-lg shadow-lg`,`transition-all hover:scale-110 active:scale-95`,e?`bg-blue-500 text-white scale-110`:`bg-neutral-800 text-neutral-400 hover:text-white`),children:(0,Q.jsx)(u,{size:20})})})}),(0,Q.jsx)(k,{children:(0,Q.jsxs)(A,{side:`top`,sideOffset:8,align:`end`,collisionPadding:16,className:r(`z-50 w-72 max-h-[calc(100dvh-6rem)] overflow-y-auto rounded-lg bg-neutral-900 p-4 text-sm text-neutral-200 shadow-xl`,`border border-neutral-700`,`data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95`,`data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95`),children:[(0,Q.jsxs)(`div`,{className:`mb-2 flex items-center justify-between`,children:[(0,Q.jsx)(`span`,{className:`font-semibold text-white`,children:R.help.title}),(0,Q.jsx)(ne,{"aria-label":R.toolbar.close,className:`text-neutral-500 hover:text-white transition-colors`,children:(0,Q.jsx)(m,{size:14})})]}),(0,Q.jsx)(`p`,{className:`mb-3 text-neutral-400`,children:R.help.description}),(0,Q.jsxs)(`ul`,{className:`space-y-1.5 text-neutral-300`,children:[(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`strong`,{className:`text-neutral-100`,children:R.help.controlLabels.drag}),` —`,` `,R.help.controls.drag]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`strong`,{className:`text-neutral-100`,children:R.help.controlLabels.shiftDrag}),` `,`— `,R.help.controls.shiftDrag]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`strong`,{className:`text-neutral-100`,children:R.help.controlLabels.scrollPinch}),` `,`— `,R.help.controls.scrollPinch]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`strong`,{className:`text-neutral-100`,children:R.help.controlLabels.clickEdge}),` `,`— `,R.help.controls.clickEdge]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`strong`,{className:`text-neutral-100`,children:R.help.controlLabels.doubleClickEdge}),` `,`— `,R.help.controls.doubleClickEdge]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`strong`,{className:`text-neutral-100`,children:R.help.controlLabels.doubleClickLine}),` `,`— `,R.help.controls.doubleClickLine]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`strong`,{className:`text-neutral-100`,children:R.help.controlLabels.dragVertex}),` `,`— `,R.help.controls.dragVertex]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`strong`,{className:`text-neutral-100`,children:R.help.controlLabels.selectEdgeTapVertex}),` `,`— `,R.help.controls.selectEdgeTapVertex]}),(0,Q.jsxs)(`li`,{children:[(0,Q.jsx)(`strong`,{className:`text-neutral-100`,children:R.help.controlLabels.holdDragLineVertex}),` `,`— `,R.help.controls.holdDragLineVertex]})]}),(0,Q.jsx)(`p`,{className:`mt-3 text-xs text-neutral-500`,children:R.help.intersectionHint}),(0,Q.jsx)(ee,{className:`fill-neutral-900`})]})})]})}),Dn=(0,B.memo)(({puzzle:e})=>{let[t,n]=(0,B.useState)(!1),i=R.puzzles[e.id];return i===void 0?null:(0,Q.jsxs)(te,{open:t,onOpenChange:n,children:[(0,Q.jsx)(x,{title:R.toolbar.puzzle,delayDuration:300,children:(0,Q.jsx)(re,{asChild:!0,children:(0,Q.jsx)(`button`,{type:`button`,"aria-label":R.toolbar.puzzle,className:r(`flex size-10 items-center justify-center rounded-lg shadow-lg`,`transition-all hover:scale-110 active:scale-95`,t?`bg-blue-500 text-white scale-110`:`bg-neutral-800 text-neutral-400 hover:text-white`),children:(0,Q.jsx)(Ye,{size:20})})})}),(0,Q.jsx)(k,{children:(0,Q.jsxs)(A,{side:`top`,sideOffset:8,align:`end`,collisionPadding:16,className:r(`z-50 w-72 max-h-[calc(100dvh-6rem)] overflow-y-auto rounded-lg bg-neutral-900 p-4 text-sm text-neutral-200 shadow-xl`,`border border-neutral-700`,`data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95`,`data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95`),children:[(0,Q.jsxs)(`div`,{className:`mb-2 flex items-center justify-between`,children:[(0,Q.jsx)(`span`,{className:`font-semibold text-white`,children:i.name}),(0,Q.jsx)(ne,{"aria-label":R.toolbar.close,className:`text-neutral-500 hover:text-white transition-colors`,children:(0,Q.jsx)(m,{size:14})})]}),(0,Q.jsx)(He,{puzzle:e,label:R.solutionImageAlt,className:`mb-3 w-full rounded-md border border-neutral-700`}),(0,Q.jsx)(`p`,{className:`text-neutral-300`,children:i.description}),(0,Q.jsx)(ee,{className:`fill-neutral-900`})]})})]})}),$=(0,B.memo)(({active:e=!1,disabled:t=!1,onClick:n,children:i,label:a,tooltipDelayMs:o=300})=>(0,Q.jsx)(x,{title:a,delayDuration:o,children:(0,Q.jsx)(`button`,{type:`button`,onClick:n,disabled:t,"aria-label":a,"aria-pressed":e,className:r(`flex size-10 items-center justify-center rounded-lg shadow-lg`,`transition-all`,t?`bg-neutral-900 text-neutral-600 cursor-not-allowed`:`hover:scale-110 active:scale-95`,!t&&e&&`bg-blue-500 text-white`,!t&&!e&&`bg-neutral-800 text-neutral-400 hover:text-white`),children:i})})),On=D(),kn=b(({puzzle:e})=>{let t=(0,B.useRef)(null),n=Tn(),r=i(),a=s(()=>{r(`/stereometry`)});h({label:R.nav.backToPuzzlesLabel,onActivate:a}),(0,B.useEffect)(()=>{let r=t.current;if(o(r))return;let i=xn({canvas:r,puzzle:e,getInteractionMode:()=>n.interactionMode,onFpsUpdate:n.setFps});return n.attach(i),()=>{n.detach(),i.destroy()}},[e,n]);let c=s(()=>{n.setInteractionMode(`rotate`)}),l=s(()=>{n.setInteractionMode(`pan`)});return(0,Q.jsx)(w,{className:`h-full w-full`,children:(0,Q.jsxs)(`div`,{className:`h-full w-full`,children:[(0,Q.jsx)(`canvas`,{ref:t,className:`h-full w-full [touch-action:none]`}),!On&&(0,Q.jsxs)(`div`,{className:`absolute top-3 right-3 rounded bg-black/60 px-2 py-0.5 font-mono text-xs text-neutral-400`,children:[n.fps,` FPS`]}),(0,Q.jsxs)(`div`,{className:`fixed right-4 bottom-4 flex gap-2`,children:[(0,Q.jsx)(Dn,{puzzle:e}),(0,Q.jsx)(En,{}),(0,Q.jsx)($,{onClick:n.undo,label:R.toolbar.undo,disabled:!n.canUndo,children:(0,Q.jsx)(f,{size:20})}),(0,Q.jsx)($,{onClick:n.redo,label:R.toolbar.redo,disabled:!n.canRedo,children:(0,Q.jsx)(d,{size:20})}),(0,Q.jsx)($,{active:n.interactionMode===`rotate`,onClick:c,label:R.toolbar.rotate,children:(0,Q.jsx)(p,{size:20})}),(0,Q.jsx)($,{active:n.interactionMode===`pan`,onClick:l,label:R.toolbar.pan,children:(0,Q.jsx)(Je,{size:20})})]})]})})}),An=(0,B.memo)(()=>{let{puzzleId:e}=a(),t=Ee(e);return o(t)?(0,Q.jsx)(n,{to:`/stereometry`,replace:!0}):(0,Q.jsx)(kn,{puzzle:t})});export{An as Stereometry};