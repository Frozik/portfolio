...
`;function q(e){let t=!1,n;return J(e).then(e=>{t?e():n=e}),()=>{t=!0,n?.()}}async function J(e){let t=await c(e),{device:n}=t,r=n.createShaderModule({code:K}),i=T(n,C,4),l=a(4),u=k(n),d=new o([new N(r,l),new G(i,u.compositeBindGroupLayout,u.compositeSampler,u.compositeUniformBuffer,r),new A(i,u),new W]);d.initAll(t);let f=s({canvas:e,context:t,layerManager:d});return()=>{f(),d.dispose(),l.dispose(),i.destroy(),n.destroy()}}var Y=t(),X=(0,f.memo)(()=>{let e=(0,f.useRef)(null);return(0,f.useEffect)(()=>{if(e.current)return q(e.current)},[]),(0,Y.jsx)(i,{className:`h-full w-full`,children:(0,Y.jsx)(`canvas`,{ref:e,className:`h-full w-full`})})});export{X as Charts};