import{J as e,X as t,Y as n,i as r,o as i,r as a,wt as o,z as s}from"./c-BUiHm-Fm.js";import{t as c}from"./c-CzYv-hUz.js";import{n as l,t as u}from"./c-B-UvccR9.js";import{t as d}from"./c-B5wHFoBZ.js";var f=o(n(),1),p={r:.02745,g:.03529,b:.04706,a:1},m=.5,h=.7,g=1e-4,_=16384,v=.5,y=.4,b=.6,x=`rgba8unorm`;function S(e){return Math.trunc(e/20/4)*4+1}function C(e){return Math.trunc(e/20/4)*4+1}var w={color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}};function T(e,n,r){let i=null,a=null,o=null,s=null,c=null;return{ensureOffscreenTextures(l,u,d,f,p){return!t(i)&&i.width===l&&i.height===u?t(a)||t(s)||t(c)?null:{offscreenMsaaView:a,offscreenResolveView:s,compositeBindGroup:c}:(i?.destroy(),o?.destroy(),l===0||u===0?(i=null,a=null,o=null,s=null,c=null,null):(i=e.createTexture({size:[l,u],format:n,sampleCount:r,usage:GPUTextureUsage.RENDER_ATTACHMENT}),a=i.createView(),o=e.createTexture({size:[l,u],format:n,sampleCount:1,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),s=o.createView(),c=e.createBindGroup({layout:d,entries:[{binding:0,resource:s},{binding:1,resource:f},{binding:2,resource:{buffer:p}}]}),{offscreenMsaaView:a,offscreenResolveView:s,compositeBindGroup:c}))},destroy(){i?.destroy(),o?.destroy()}}}var E=`struct CompositeUniforms {
    opacity: f32,
};
...
`;function J(e){let t=!1,n;return Y(e).then(e=>{t?e():n=e}),()=>{t=!0,n?.()}}async function Y(e){let t=await i(e),{device:n}=t,o=n.createShaderModule({code:q}),s=T(n,x,4),c=r(4),l=k(n),u=new a([new N(o,c),new G(s,l.compositeBindGroupLayout,l.compositeSampler,l.compositeUniformBuffer,o),new A(s,l),new W]);u.initAll(t);let d=K({canvas:e,context:t,layerManager:u});return()=>{d(),u.dispose(),c.dispose(),s.destroy(),n.destroy()}}var X=e(),Z=(0,f.memo)(()=>{let e=(0,f.useRef)(null);return(0,f.useEffect)(()=>{if(e.current)return J(e.current)},[]),(0,X.jsx)(c,{className:`h-full w-full`,children:(0,X.jsx)(`canvas`,{ref:e,className:`h-full w-full`})})});export{Z as Charts};