...
export const WebGpuUnsupportedNotice = memo(({ className }: { className?: string }) => (
  <div
  ...
  >
    ...
    <div>
      ...
      <p className="mt-2 max-w-md text-sm leading-relaxed text-text-secondary">{t.description}</p>
    </div>
