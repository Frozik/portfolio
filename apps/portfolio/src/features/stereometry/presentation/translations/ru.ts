...
export const stereometryTranslationsRu: TranslationOf<typeof stereometryTranslationsEn> = {
  ...
  nav: {
    backToPuzzlesLabel: 'Назад к списку задач',
  },
  puzzles: {
    puzzle_1: {
      shortName: 'Сечение пирамиды',
    ...
    puzzle_2: {
      shortName: 'Пересечение плоскостей',
      name: 'Линия пересечения двух плоскостей',
      description:
        'Дана пятиугольная призма и четыре отрезка, образующие две пары пересекающихся отрезков. Каждая пара задаёт плоскость. Постройте линию пересечения этих двух плоскостей.',
    },
  },
