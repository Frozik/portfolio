/** Water swaps phase every 32 ticks — a full shimmer cycle is 64. */
export const ANIMATION_TICKS_PER_FRAME = 32;

/** Tracks advance by distance, not time — the original toggles frames per unit moved. */
export const TRACK_ADVANCE_DISTANCE_WU = 1;

/** Seven 8-tick steps ping-pong the four star frames across the domain's spawn window. */
...
/** A kill's reward flashes for 12 ticks; a bonus pickup's 500 lingers for 50. */
