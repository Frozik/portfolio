  ...
  projects: {
    ...
    entries: {
      ...
      'space-golf': {
        ...
        description:
          'Гравитационный гольф по мотивам Gravity Golfing: стена, которой коснулся шар, становится полом, срезы под 45° только отбивают, а до лунки добираются по цепочке стен. Бесконечные процедурные острова на полуметровой сетке, физика, написанная под игру, блоки в хохломе, мерцающие мембраны и тягучая масса — всё нарисовано на WebGPU.',
