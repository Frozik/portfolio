...
/**
 * How far the finger has to travel from the tank for the throttle to reach the wall. Sized
...
/**
 * Drag-to-aim: the vector from the active tank to the finger sets the barrel and the
