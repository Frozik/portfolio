...
/**
 * Touch-overlay opacities, the same visual language as the tanks D-pad. They live here as
...
/** Press-and-hold on a stepper repeats like a text cursor. */
export const STEPPER_INITIAL_REPEAT_MS = 320;
export const STEPPER_REPEAT_INTERVAL_MS = 60;

/** Glass chrome shared by every full-screen overlay. */
