...
export const confRuTranslations: TranslationOf<typeof confEnTranslations> = {
  ...
  room: {
    ...
    glassesPickerLabel: 'Выбрать форму AR-очков',
    glassesStyleNone: 'Без очков',
    glassesStyleRound: 'Круглые',
    glassesStyleHippie: 'Звезда хиппи',
    glassesStyleTeacher: 'Учительские',
    localLabel: 'Вы',
