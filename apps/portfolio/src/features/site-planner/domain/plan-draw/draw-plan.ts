...
import { buildVariableWidthRibbon } from '../geometry/offset-polygon';
import type { PathRibbon } from '../geometry/path-ribbon';
import type { MultiPolygon } from '../geometry/polygon-types';
import type { EditTarget } from '../model/editor-mode';
import type { DeviceId } from '../model/electrical';
import type { UtilitySystem } from '../model/foundation';
import type { FurnitureInstance } from '../model/furniture';
...
import { isWallClosed } from '../model/walls';
import type { AnalysisRaster } from '../terrain/analysis-raster';
import type { ContourPolyline } from '../terrain/contours';
import type { Meters } from '../units';
import type { KeyPointSnap } from '../view/object-snapping';
import type { PlanLayerKind } from '../view/plan-layers';
